@php
    $totalOrder = \PZone\Core\Admin\Models\AdminOrder::count();
    $styleStatus = \PZone\Core\Admin\Models\AdminOrder::$mapStyleStatus;
@endphp
@if ($totalOrder)
@php
    $arrStatus = \PZone\Core\Front\Models\ShopOrderStatus::pluck('name','id')->all();
    $groupOrder = (new \PZone\Core\Front\Models\ShopOrder)->all()->groupBy('status');
@endphp
    <li id="summary">
    <ul>
