                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right" style="margin-right: 5px">
                            <a href="{{ pz_route_admin('admin_order.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ pz_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ pz_route_admin('admin_order.create') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">

                    <div class="card-body">

                            <div class="form-group row {{ $errors->has('customer_id') ? ' text-red' : '' }}">
                                <label for="customer_id" class="col-sm-2 asterisk col-form-label">{{ pz_language_render('order.admin.select_customer') }}</label>
                                <div class="col-sm-8">
                                    <select class="form-control customer_id " style="width: 100%;" name="customer_id">
                                        <option value="">{{ pz_language_render('order.admin.select_customer') }}</option>
                                ...
                                <div class="input-group-append">
                                    <a href="{{ pz_route_admin('admin_customer.index') }}"><button type="button" id="button-filter" class="btn btn-success  btn-flat"><i class="fa fa-plus" title="Add new"></i></button></a>
                                </div>
                            </div>

                            <div class="form-group row {{ $errors->has('email') ? ' text-red' : '' }}" id="email">
                                <label for="email" class="col-sm-2 col-form-label">{{ pz_language_render('order.email') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('first_name') ? ' text-red' : '' }}">
                                <label for="first_name" class="col-sm-2 col-form-label">{{ pz_language_render('order.first_name') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (pz_config_admin('customer_lastname'))
                            <div class="form-group row {{ $errors->has('last_name') ? ' text-red' : '' }}">
                                <label for="last_name" class="col-sm-2 col-form-label">{{ pz_language_render('order.last_name') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (pz_config_admin('customer_name_kana'))
                            <div class="form-group row {{ $errors->has('first_name_kana') ? ' text-red' : '' }}">
                                <label for="first_name_kana" class="col-sm-2 col-form-label">{{ pz_language_render('order.first_name_kana') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group row {{ $errors->has('last_name_kana') ? ' text-red' : '' }}">
                                <label for="last_name_kana" class="col-sm-2 col-form-label">{{ pz_language_render('order.last_name_kana') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (pz_config_admin('customer_company'))
                            <div class="form-group row {{ $errors->has('company') ? ' text-red' : '' }}">
                                <label for="company" class="col-sm-2 col-form-label">{{ pz_language_render('order.company') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (pz_config_admin('customer_postcode'))
                            <div class="form-group row {{ $errors->has('postcode') ? ' text-red' : '' }}">
                                <label for="postcode" class="col-sm-2 col-form-label">{{ pz_language_render('order.postcode') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @endif
                            ...
                            <div class="form-group row {{ $errors->has('address1') ? ' text-red' : '' }}">
                                <label for="address1" class="col-sm-2 col-form-label">{{ pz_language_render('order.address1') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        @if (pz_config_admin('customer_address2'))    
                            <div class="form-group row {{ $errors->has('address2') ? ' text-red' : '' }}">
                                <label for="address2" class="col-sm-2 col-form-label">{{ pz_language_render('order.address2') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group row {{ $errors->has('address3') ? ' text-red' : '' }}">
                            <label for="address3" class="col-sm-2 col-form-label">{{ pz_language_render('order.address3') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                    ...
                    @endif
                        ...
                        @if (pz_config_admin('customer_country'))
                            <div class="form-group row {{ $errors->has('country') ? ' text-red' : '' }}">
                                <label for="country" class="col-sm-2 asterisk col-form-label">{{ pz_language_render('order.country') }}</label>
                                <div class="col-sm-8">
                        ...
                        @if (pz_config_admin('customer_phone'))
                            <div class="form-group row  {{ $errors->has('phone') ? ' text-red' : '' }}">
                                <label for="phone" class="col-sm-2 col-form-label">{{ pz_language_render('order.phone') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                        ...
                        @endif
                            ...
                            <div class="form-group row  {{ $errors->has('currency') ? ' text-red' : '' }}">
                                <label for="currency" class="col-sm-2 asterisk col-form-label">{{ pz_language_render('order.currency') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row  {{ $errors->has('exchange_rate') ? ' text-red' : '' }}">
                                <label for="exchange_rate" class="col-sm-2 col-form-label">{{ pz_language_render('order.exchange_rate') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                            ...
                            <div class="form-group row">
                                <label for="comment" class="col-sm-2 col-form-label">{{ pz_language_render('order.note') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row  {{ $errors->has('payment_method') ? ' text-red' : '' }}">
                                <label for="payment_method" class="col-sm-2 col-form-label">{{ pz_language_render('order.payment_method') }}</label>
                                <div class="col-sm-8">
                                    <select class="form-control payment_method " style="width: 100%;" name="payment_method">
                                      @foreach ($paymentMethod as $k => $v)
                                            <option value="{{ $k }}" {{ (old('payment_method') ==$k) ? 'selected':'' }}>{{ pz_language_render($v)}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row  {{ $errors->has('shipping_method') ? ' text-red' : '' }}">
                                <label for="shipping_method" class="col-sm-2 col-form-label">{{ pz_language_render('order.shipping_method') }}</label>
                                <div class="col-sm-8">
                                    <select class="form-control shipping_method " style="width: 100%;" name="shipping_method">
                                      @foreach ($shippingMethod as $k => $v)
                                            <option value="{{ $k }}" {{ (old('shipping_method') ==$k) ? 'selected':'' }}>{{ pz_language_render($v)}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row  {{ $errors->has('status') ? ' text-red' : '' }}">
                                <label for="status" class="col-sm-2 col-form-label">{{ pz_language_render('order.status') }}</label>
                                <div class="col-sm-8">
...
function addInfo(){
    ...
    if(id){
       $.ajax({
            url : '{{ pz_route_admin('admin_order.user_info') }}',
            type : "get",
