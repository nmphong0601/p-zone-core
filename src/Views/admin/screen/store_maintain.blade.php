                            ...
                            <div class="card-body">
                                <div
                                    ...
                                    <label for="{{ $code }}__maintain_content"
                                        class="col-sm-2 col-form-label">{{ pz_language_render('admin.maintain.description') }}</label>
                                    <div class="col-sm-8">
                                ...
                                <label for="{{ $code }}__maintain_note"
                                    class="col-sm-2 col-form-label">{{ pz_language_render('admin.maintain.description_note') }}</label>
                                <div class="col-sm-8">
