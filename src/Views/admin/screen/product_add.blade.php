...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a target=_new href="{{ pz_route_admin('admin_product.index') }}" class="btn  btn-flat btn-default" title="List">
            ...
            <!-- form start -->
            <form action="{{ pz_route_admin('admin_product.create') }}" method="post" name="form_name" accept-charset="UTF-8" 
                class="form-horizontal" id="form-main" enctype="multipart/form-data">
                <input type="hidden" name="kind" value="{{ PZ_PRODUCT_SINGLE }}">
                ...
                <div id="main-add" class="card-body">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__name"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.name') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span>
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row kind  {{ $errors->has('descriptions.'.$code.'.content') ? ' text-red' : '' }}">
                            <label for="{{ $code }}__content" class="col-sm-2 col-form-label">
                                {{ pz_language_render('product.content') }}
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row kind  {{ $errors->has('category') ? ' text-red' : '' }}">
                            ...
                            <label for="category" class="col-sm-2 col-form-label">
                                {{ pz_language_render('product.admin.select_category') }}
                            </label>
                            <div class="col-sm-8">
                                <div class="input-group">
...
@if (pz_check_multi_shop_installed())
                            ...
                            <div class="form-group row kind  {{ $errors->has('shop_store') ? ' text-red' : '' }}">
                                ...
                                <label for="shop_store" class="col-sm-2 col-form-label">
                                    {{ pz_language_render('admin.select_store') }}
                                </label>
                                <div class="col-sm-8">
...
@endif
                        ...
                        <div class="form-group row kind  {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image" class="col-sm-2 col-form-label">
                                {{ pz_language_render('product.image') }}
                            </label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="btn btn-primary lfm" data-input="image" data-preview="preview_image" data-type="product">
                                            <i class="fas fa-image"></i> {{pz_language_render('product.admin.choose_image')}}
                                        </span>
                                    </div>
                                </div>
                                @if ($errors->has('image'))
                        ...
                        <div class="form-group row kind  {{ $errors->has('sku') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                <span class="form-text">
                                    {{ pz_language_render('product.sku_validate') }}
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row kind  {{ $errors->has('alias') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                <span class="form-text">
                                    {{ pz_language_render('product.alias_validate') }}
                                </span>
                                @endif
                            </div>
                        </div>
...
@if (pz_config_admin('product_brand'))
                        ...
                        <div class="form-group row kind   {{ $errors->has('brand_id') ? ' text-red' : '' }}">
                            <label for="brand_id"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.brand') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
...
@if (pz_config_admin('product_supplier'))
                        ...
                        <div class="form-group row kind   {{ $errors->has('supplier_id') ? ' text-red' : '' }}">
                            <label for="supplier_id"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.supplier') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
...
@if (pz_config_admin('product_tax'))
                        ...
                        <div class="form-group row kind   {{ $errors->has('tax_id') ? ' text-red' : '' }}">
                            <label for="tax_id"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.tax') }}
                            </label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                <select class="form-control input-sm tax_id select2"
                                    name="tax_id">
                                    <option value="0" {{ (old('tax_id') == 0) ? 'selected':'' }}>{{ pz_language_render('admin.tax.non_tax') }}</option>
                                    <option value="auto" {{ (old('tax_id') == 'auto') ? 'selected':'' }}>{{ pz_language_render('admin.tax.auto') }}</option>
                                    @foreach ($taxs as $k => $v)
                        ...
                        <div class="form-group row kind   {{ $errors->has('property') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="radioPrimary{{ $key }}" name="property" value="{{ $key }}" {{ ((!old() && $key == PZ_PROPERTY_PHYSICAL) || old('property') == $key)?'checked':'' }}>
                                ...
                                @endif
                                <div style="margin-top: 10px; {{ (old('property') != PZ_PROPERTY_DOWNLOAD) ? 'display:none':'' }}" id="download_path">
                                    <input type="text"  name="download_path" value="{{ old('download_path') }}" class="form-control input-sm" placeholder="{{ pz_language_render('product.download_path') }}" />
                                </div>
                            </div>
                        </div>
                        {{-- //property --}}
...
@if (pz_config_admin('product_attribute'))
                        ...
                        <div class="form-group kind  row">
                            <div class="col-sm-2">
                                <label>{{ pz_language_render('product.attribute') }} (<a target=_new href="{{ pz_route_admin('admin_attribute_group.index') }}"><i class="fa fa-plus" aria-hidden="true"></i></a>)</label>
                            </div>
                            <div class="col-sm-8">
