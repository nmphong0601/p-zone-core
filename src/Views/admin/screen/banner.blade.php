                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ pz_route_admin('admin_banner.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ pz_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group  row {{ $errors->has('image') ? ' text-red' : '' }}">
                                <label for="image" class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.image') }}</label>
                                <div class="col-sm-8">
                                    ...
                                    <div id="preview_image" class="img_holder">
                                        ...
                                        <img src="{{ pz_file(old('image',$banner['image']??'')) }}">
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row {{ $errors->has('url') ? ' text-red' : '' }}">
                                <label for="url" class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.url') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group  row {{ $errors->has('title') ? ' text-red' : '' }}">
                                <label for="title" class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.title') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-prepend">
                            ...
                            <div class="form-group row {{ $errors->has('target') ? ' text-red' : '' }}">
                                    <label for="target" class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.select_target') }}</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('html') ? ' text-red' : '' }}">
                                <label for="html" class="col-sm-2 col-form-label">{{ pz_language_render('admin.email_template.html') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('type') ? ' text-red' : '' }}">
                                <label class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.type') }}</label>
                                <div class="col-sm-8">
                                <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href="{{ pz_route_admin('admin_banner_type.index') }}" class="btn  btn-flat" title="New">
                            ...
                            <div class="form-group  row {{ $errors->has('sort') ? ' text-red' : '' }}">
                                <label for="sort" class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.sort') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (pz_check_multi_shop_installed())
                            ...
                            @php
                            $listStore = [];
                            if (function_exists('pz_get_list_store_of_banner_detail')) {
                                $oldData = pz_get_list_store_of_banner_detail($banner['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
    ...
    @endif
                            <div class="form-group row ">
                                <label for="status" class="col-sm-2 col-form-label">{{ pz_language_render('admin.banner.status') }}</label>
                                <div class="col-sm-8">
...
@push('styles')
<link rel="stylesheet" href="{{ pz_file('admin/plugin/mirror/doc/docs.css')}}">
<link rel="stylesheet" href="{{ pz_file('admin/plugin/mirror/lib/codemirror.css')}}">
@endpush

@push('scripts')
<script src="{{ pz_file('admin/plugin/mirror/lib/codemirror.js')}}"></script>
<script src="{{ pz_file('admin/plugin/mirror/mode/javascript/javascript.js')}}"></script>
<script src="{{ pz_file('admin/plugin/mirror/mode/css/css.js')}}"></script>
<script src="{{ pz_file('admin/plugin/mirror/mode/htmlmixed/htmlmixed.js')}}"></script>
<script>
