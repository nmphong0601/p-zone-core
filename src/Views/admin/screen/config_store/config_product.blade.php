  ...
  <div class="col-md-5">
    <div class="card">
      <div class="card-header with-border">
        <h3 class="card-title">{{ pz_language_render('product.admin.setting_info') }}</h3>
      </div>
      ...
      <div class="card-body table-responsivep-0">
       <table class="table table-hover box-body text-wrap table-bordered">
         <tbody>
           ...
           <tr>
            <td>{{ pz_language_render('product.config_manager.tax') }}</td>
            <td><a href="#" class="editable-required" data-name="product_tax" data-type="select" data-pk="" data-source="{{ json_encode($taxs) }}" data-url="{{ $urlUpdateConfig }}" data-title="{{ pz_language_render('product.config_manager.tax') }}" data-value="{{ pz_config('product_tax', $storeId) }}" data-original-title="" title="" data-placement="left"></a></td>
          </tr>
           @else
           <tr>
    ...
    <div class="card">
      ...
      <div class="card-body table-responsivep-0">
       <table class="table table-hover box-body text-wrap table-bordered">
        <thead>
          <tr>
            <th>{{ pz_language_render('product.config_manager.field') }}</th>
            <th>{{ pz_language_render('product.config_manager.value') }}</th>
            <th>{{ pz_language_render('product.config_manager.required') }}</th>
          </tr>
        </thead>
         <tbody>
