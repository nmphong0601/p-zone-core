...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action="{{ pz_route_admin('admin_template.process_import') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                      <span class="btn button-upload">{{ pz_language_render('admin.template.import_submit') }}</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span class="form-text">
                                        <i class="fa fa-info-circle"></i> {!! pz_language_render('admin.template.import_note') !!}
                                    </span>
                                    @endif
                                </div>
                            </div>
