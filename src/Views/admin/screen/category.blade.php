            ...
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a href="{{ pz_route_admin('admin_category.index') }}" class="btn  btn-flat btn-default" title="List"><i
                    ...
                    <div class="card">
                        ...
                        <div class="form-group row  {{ $errors->has('descriptions.'.$code.'.title') ? ' text-red' : '' }}">
                            <label for="{{ $code }}__title"
                                class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.title') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.keyword') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.description') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row {{ $errors->has('parent') ? ' text-red' : '' }}">
                            <label for="parent"
                                class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.select_category') }}</label>
                            <div class="col-sm-8">
...
@if (pz_check_multi_store_installed())
                        ...
                        @php
                        $listStore = [];
                        if (function_exists('pz_get_list_store_of_category_detail')) {
                                $oldData = pz_get_list_store_of_category_detail($category['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
...
@endif
                        ...
                        <div class="form-group row  {{ $errors->has('alias') ? ' text-red' : '' }}">
                            <label for="alias" class="col-sm-2 col-form-label">{!! pz_language_render('admin.category.alias') !!}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group row  {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image" class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                ...
                                <div id="preview_image" class="img_holder">
                                    ...
                                    <img src="{{ pz_file(old('image',$category['image']??'')) }}">
                                    @endif
                        ...
                        <div class="form-group row  {{ $errors->has('sort') ? ' text-red' : '' }}">
                            <label for="sort" class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.sort') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group  row">
                            <label for="top" class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.top') }}</label>
                            <div class="col-sm-8">
                                <input class="checkbox" type="checkbox" name="top"
                                    {{ old('top',(empty($category['top'])?0:1))?'checked':''}}>
                            </div>
                            <span class="form-text">
                                <i class="fa fa-info-circle"></i> {{ pz_language_render('admin.category.top_help') }}
                            </span>
                        </div>

                        <div class="form-group  row">
                            <label for="status" class="col-sm-2 col-form-label">{{ pz_language_render('admin.category.status') }}</label>
                            <div class="col-sm-8">
