...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float right  mr-5">
                        <a href="{{ pz_route_admin('admin_product.index') }}" class="btn  btn-flat btn-default" title="List">
                            <i class="fa fa-list"></i><span class="hidden-xs"> {{ pz_language_render('admin.back_list') }}</span>
                        </a>
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ pz_route_admin('admin_product.edit',['id'=>$product['id']]) }}" method="post" accept-charset="UTF-8"
            ...
            <div class="d-flex d-flex justify-content-center mb-3"  id="start-add">
                <div class="form-group">
                    <div style="width: 300px;text-align: center; z-index:999">
                        <b>{{ pz_language_render('product.kind') }}:</b> {{ $kinds[$product->kind]??'' }}
                    </div>
                </div>
            </div>    
@endif
                ...
                <div class="card-body">
                    ...
                    <div class="card card-{{ ($product->kind == 1) ? 'success': (($product->kind == 2) ? 'danger': '') }}">
                        <div class="card-header with-border">
                            <h3 class="card-title">{{ $language->name }} {!! pz_image_render($language->icon,'20px','20px', $language->name) !!}</h3>
                            <div class="card-tools">
                        ...
                        <div class="form-group row  {{ $errors->has('descriptions.'.$code.'.name') ? ' text-red' : '' }}">
                            <label for="{{ $code }}__name"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.name') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                    <span class="form-text">
                                        <i class="fa fa-info-circle"></i> {{ pz_language_render('admin.max_c',['max'=>200]) }}
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.keyword') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.description') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                ...
                                @else
                                    <span class="form-text">
                                        <i class="fa fa-info-circle"></i> {{ pz_language_render('admin.max_c',['max'=>300]) }}
                                    </span>
                                @endif
                            </div>
                        </div>

                        @if ($product->kind == PZ_PRODUCT_SINGLE || $product->kind == PZ_PRODUCT_BUILD)
                        <div
                            class="form-group row {{ $errors->has('descriptions.'.$code.'.content') ? ' text-red' : '' }}">
                            <label for="{{ $code }}__content"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.content') }}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row {{ $errors->has('category') ? ' text-red' : '' }}">
                            <label for="category"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.admin.select_category') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                <select class="form-control category select2" multiple="multiple"
                                    data-placeholder="{{ pz_language_render('product.admin.select_category') }}"
                                    name="category[]">
                                    <option value=""></option>
                                ...
                                <div class="input-group-append">
                                    <a target=_new href="{{ pz_route_admin('admin_category.index') }}" class="btn  btn-flat" title="New">
 ...
 @if (pz_check_multi_shop_installed())
                        {{-- select shop_store --}}
                        @php
                        if (function_exists('pz_get_list_store_of_product_detail')) {
                            $oldData = pz_get_list_store_of_product_detail($product->id);
                        } else {
                            $oldData = null;
                        }
                        $listStore = [];
                        ...
                        <div class="form-group row {{ $errors->has('shop_store') ? ' text-red' : '' }}">
                            <label for="shop_store"
                                class="col-sm-2 col-form-label">{{ pz_language_render('admin.select_store') }}</label>
                            <div class="col-sm-8">
                                <select class="form-control shop_store select2" 
                                @if (pz_check_multi_store_installed())
                                    multiple="multiple"
                                @endif
                                data-placeholder="{{ pz_language_render('admin.select_store') }}" style="width: 100%;"
                                name="shop_store[]">
                                    <option value=""></option>
                                    @foreach (pz_get_list_code_store() as $k => $v)
                                    <option value="{{ $k }}"
...
@endif
                        ...
                        <div class="form-group row  {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image" class="col-sm-2 col-form-label">{{ pz_language_render('product.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" id="image" name="image"
                                        ...
                                        <div class="input-group-append">
                                            <a data-input="image" data-preview="preview_image" data-type="product"
                                                ...
                                                <i class="fa fa-image"></i> {{pz_language_render('product.admin.choose_image')}}
                                            </a>
                                        </div>
                                </div>
                                @if ($errors->has('image'))
                                ...
                                <div id="preview_image" class="img_holder">
                                    @if (old('image',$product->image))
                                        <img src="{{ pz_file(old('image',$product->image)) }}">
                                    @endif
                                </div>
                                @php
                                    ...
                                    <div class="input-group"><input type="text" id="sub_image_{{ $key }}"
                                            ...
                                            class="input-group-btn"><span><a data-input="sub_image_{{ $key }}"
                                                    ...
                                                    class="btn btn-flat btn-primary lfm"><i
                                                        class="fa fa-image"></i>
                                                    {{pz_language_render('product.admin.choose_image')}}</a></span><span
                                ...
                                <button type="button" id="add_sub_image" class="btn btn-flat btn-success">
                                    ...
                                    {{ pz_language_render('product.admin.add_sub_image') }}
                                </button>
                        ...
                        <div class="form-group row {{ $errors->has('sku') ? ' text-red' : '' }}">
                            <label for="sku" class="col-sm-2 col-form-label">{{ pz_language_render('product.sku') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                ...
                                @else
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ pz_language_render('product.sku_validate') }}
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row {{ $errors->has('alias') ? ' text-red' : '' }}">
                            <label for="alias" class="col-sm-2 col-form-label">{!! pz_language_render('product.alias') !!}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                ...
                                @else
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ pz_language_render('product.alias_validate') }}
                                </span>
                                @endif
                            </div>
                        </div>
...
@if (pz_config_admin('product_brand') && ($product->kind == PZ_PRODUCT_SINGLE || $product->kind == PZ_PRODUCT_BUILD))
                        {{-- Brand --}}
                        <div class="form-group row kind kind0 kind1 {{ $errors->has('brand_id') ? ' text-red' : '' }}">
                            <label for="brand_id" class="col-sm-2 col-form-label">{{ pz_language_render('product.brand') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a target=_new href="{{ pz_route_admin('admin_brand.index') }}" class="btn  btn-flat" title="New">
                                        <i class="fa fa-plus" title="{{ pz_language_render('action.add') }}"></i>
                                     </a>
                                </div>
                                </div>
...
@if (pz_config_admin('product_supplier') && ($product->kind == PZ_PRODUCT_SINGLE || $product->kind == PZ_PRODUCT_BUILD))
                        {{-- supplier --}}
                        <div class="form-group row kind kind0 kind1 {{ $errors->has('supplier_id') ? ' text-red' : '' }}">
                            <label for="supplier_id" class="col-sm-2 col-form-label">{{ pz_language_render('product.supplier') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a target=_new href="{{ pz_route_admin('admin_supplier.index') }}" class="btn  btn-flat" title="New">
                                        <i class="fa fa-plus" title="{{ pz_language_render('action.add') }}"></i>
                                     </a>
                                </div>
                                </div>
...
@if (pz_config_admin('product_cost'))
                        ...
                        <div class="form-group row kind kind0 kind1  {{ $errors->has('cost') ? ' text-red' : '' }}">
                            <label for="cost" class="col-sm-2 col-form-label">{{ pz_language_render('product.cost') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (pz_config_admin('product_price'))
                        ...
                        <div class="form-group row  {{ $errors->has('price') ? ' text-red' : '' }}">
                            <label for="price" class="col-sm-2 col-form-label">{{ pz_language_render('product.price') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (pz_config_admin('product_tax'))
                    @if ($product->kind == PZ_PRODUCT_SINGLE || $product->kind == PZ_PRODUCT_BUILD)
                        {{-- Tax --}}
                        <div class="form-group row {{ $errors->has('tax_id') ? ' text-red' : '' }}">
                            <label for="tax_id" class="col-sm-2 col-form-label">{{ pz_language_render('product.tax') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                <select class="form-control tax_id select2"
                                    name="tax_id">
                                    <option value="0" {{ (old('tax_id', $product->tax_id) == 0) ? 'selected':'' }}>{{ pz_language_render('admin.tax.non_tax') }}</option>
                                    <option value="auto" {{ (old('tax_id', $product->tax_id) == 'auto') ? 'selected':'' }}>{{ pz_language_render('admin.tax.auto') }}</option>
                                    @foreach ($taxs as $k => $v)
                                    <option value="{{ $k }}"
                                ...
                                <div class="input-group-append">
                                    <a target=_new href="{{ pz_route_admin('admin_tax.index') }}" class="btn  btn-flat" title="New">
                                        <i class="fa fa-plus" title="{{ pz_language_render('action.add') }}"></i>
                                     </a>
                                </div>
                                </div>
...
@if (pz_config_admin('product_promotion'))
                        ...
                        <div class="form-group row kind kind0 kind1  {{ $errors->has('price_promotion') ? ' text-red' : '' }}">
                            <label for="price"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.price_promotion') }}</label>
                            <div class="col-sm-8">
                                ...
                                <div class="price_promotion">
                                    ...
                                    <div class="form-group">
                                            <label>{{ pz_language_render('product.price_promotion_start') }}</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" style="width: 100px;" id="price_promotion_start"
                                                    ...
                                                    value="{!!old('price_promotion_start', pz_datetime_to_date($product->promotionPrice->date_start))!!}"
                                                    class="form-control price_promotion_start date_time" data-date-format="yyyy-mm-dd"
                                                    placeholder="yyyy-mm-dd" />
                                            </div>

                                            <label>{{ pz_language_render('product.price_promotion_end') }}</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fa fa-calendar fa-fw"></i></span>
                                                </div>
                                                <input type="text" style="width: 100px;" id="price_promotion_end"
                                                    ...
                                                    value="{!!old('price_promotion_end', pz_datetime_to_date($product->promotionPrice->date_end))!!}"
                                ...
                                <button type="button" style="display: none;" id="add_product_promotion"
                                    ...
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                    {{ pz_language_render('product.admin.add_product_promotion') }}
                                </button>
                                @else
...
@if (pz_config_admin('product_stock'))
                        ...
                        <div class="form-group row {{ $errors->has('stock') ? ' text-red' : '' }}">
                            <label for="stock" class="col-sm-2 col-form-label">{{ pz_language_render('product.stock') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (pz_config_admin('product_weight'))
                        ...
                        <div class="form-group row {{ $errors->has('weight_class') ? ' text-red' : '' }}">
                            <label for="weight_class" class="col-sm-2 col-form-label">{{ pz_language_render('product.admin.weight_class') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                <select class="form-control weight_class select2"
                                    name="weight_class">
                                    <option value="">{{ pz_language_render('product.admin.select_weight') }}<option>
                                ...
                                <div class="input-group-append">
                                    <a target=_new href="{{ pz_route_admin('admin_weight_unit.index') }}" class="btn  btn-flat" title="New">
                                        <i class="fa fa-plus" title="{{ pz_language_render('action.add') }}"></i>
                                     </a>
                                </div>
                                </div>
                        ...
                        <div class="form-group row {{ $errors->has('weight') ? ' text-red' : '' }}">
                            <label for="weight" class="col-sm-2 col-form-label">{{ pz_language_render('product.weight') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (pz_config_admin('product_length'))
                        ...
                        <div class="form-group row {{ $errors->has('length_class') ? ' text-red' : '' }}">
                            <label for="length_class" class="col-sm-2 col-form-label">{{ pz_language_render('product.admin.length_class') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                <select class="form-control length_class select2"
                                    name="length_class">
                                    <option value="">{{ pz_language_render('product.admin.select_length') }}<option>
                                ...
                                <div class="input-group-append">
                                    <a target=_new href="{{ pz_route_admin('admin_length_unit.index') }}" class="btn  btn-flat" title="New">
                                        <i class="fa fa-plus" title="{{ pz_language_render('action.add') }}"></i>
                                     </a>
                                </div>
                                </div>
                        ...
                        <div class="form-group row {{ $errors->has('length') ? ' text-red' : '' }}">
                            <label for="length" class="col-sm-2 col-form-label">{{ pz_language_render('product.length') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group row {{ $errors->has('height') ? ' text-red' : '' }}">
                            <label for="height" class="col-sm-2 col-form-label">{{ pz_language_render('product.height') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group row {{ $errors->has('width') ? ' text-red' : '' }}">
                            <label for="width" class="col-sm-2 col-form-label">{{ pz_language_render('product.width') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (pz_config_admin('product_property'))
                        ...
                        <div class="form-group row kind kind0 kind1  {{ $errors->has('property') ? ' text-red' : '' }}">
                            <label for="property" class="col-sm-2 col-form-label">{{ pz_language_render('product.property') }}</label>
                            <div class="col-sm-8">
                                ...
                                <div class="icheck-primary d-inline">
                                <label>
                                    <a target=_new href="{{ pz_route_admin('admin_product_property.index') }}" title="New">
                                        <i class="fa fa-plus" title="{{ pz_language_render('action.add') }}"></i>
                                    </a>
                                </label>
                                </div>
                                ...
                                <div class="input-group" style="margin-top: 10px; {{ (old('property', $product->property) != PZ_PROPERTY_DOWNLOAD) ? 'display:none':'' }}" id="download_path">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-download"></i></span>
                                    </div>
                                    <input type="text"  name="download_path" value="{{ old('download_path', $product->downloadPath->path ?? '') }}" class="form-control input-sm" placeholder="{{ pz_language_render('product.download_path') }}" />
                                </div>
...
@if (pz_config_admin('product_available'))
                        ...
                        <div
                            ...
                            <label for="date_available"
                                class="col-sm-2 col-form-label">{{ pz_language_render('product.date_available') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-calendar fa-fw"></i></span>
...
@if (($product->kind == PZ_PRODUCT_SINGLE || $product->kind == PZ_PRODUCT_BUILD))
                        ...
                        <div class="form-group row kind kind0 kind1  {{ $errors->has('minimum') ? ' text-red' : '' }}">
                            <label for="minimum" class="col-sm-2 col-form-label">{{ pz_language_render('product.minimum') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                ...
                                @else
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ pz_language_render('product.minimum_help') }}
                                </span>
                                @endif
                            </div>
                        </div>
...
@endif
                        ...
                        <div class="form-group row  {{ $errors->has('sort') ? ' text-red' : '' }}">
                            <label for="sort" class="col-sm-2 col-form-label">{{ pz_language_render('product.admin.sort') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group row ">
                            <label for="status" class="col-sm-2 col-form-label">{{ pz_language_render('product.status') }}</label>
                            <div class="col-sm-8">
                        ...
                        {{-- Approve --}}
                        <div class="form-group row ">
                            <label for="approve" class="col-sm-2 col-form-label">{{ pz_language_render('product.approve') }}</label>
                            <div class="col-sm-8">
...
@if (pz_config_admin('product_kind'))
                        ...
                        <div class="form-group row {{ $errors->has('productInGroup') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8"><label>{{ pz_language_render('product.admin.select_product_in_group') }}</label>
                            </div>
                        </div>
                        <div class="form-group row {{ $errors->has('productInGroup') ? ' text-red' : '' }}">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8">
                                ...
                                <button type="button" id="add_product_in_group" class="btn btn-flat btn-success">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                    {{ pz_language_render('product.admin.add_product') }}
                                </button>
                                @if ($errors->has('productInGroup'))
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ $errors->first('productInGroup') }}
                        ...
                        <div class="form-group row {{ $errors->has('productBuild') ? ' text-red' : '' }}">
                            <label class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-8">
                                <label>{{ pz_language_render('product.admin.select_product_in_build') }}</label>
                            </div>
                        </div>
...
@if (pz_config_admin('product_attribute'))
                    @if ($product->kind == PZ_PRODUCT_SINGLE)
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label>{{ pz_language_render('product.attribute') }} (<a href="{{ pz_route_admin('admin_attribute_group.index') }}"><i class="fa fa-plus" aria-hidden="true"></i></a>)</label>
                            </div>
                            <div class="col-sm-8">
                                ...
                                @foreach ($attributeGroup as $attGroupId => $attName)
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>{{ pz_language_render('product.admin.add_attribute_place') }}</td>
                                            <td>{{ pz_language_render('product.admin.add_price_place') }}</td>
                                        </tr>
                                    ...
                                    @endif
                                        <tr>
                                            <td colspan="3"><br><button type="button"
                                                    ...
                                                    data-id="{{ $attGroupId }}">
                                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                                    {{ pz_language_render('product.admin.add_attribute') }}
                                                </button><br><br></td>
                                        </tr>
                                    </table>
                                @endforeach
                ...
                <div class="card-footer kind kind0  kind1 kind2 row" id="card-footer">
                    ...
                    <div class="col-md-8">
                        <div class="btn-group float-right">
                            <button type="submit" class="btn btn-primary">{{ pz_language_render('action.submit') }}</button>
                        </div>

                        <div class="btn-group float-left">
                            <button type="reset" class="btn btn-warning">{{ pz_language_render('action.reset') }}</button>
                        </div>
                    </div>
                </div>
...
{{-- input image --}}
{{-- <link rel="stylesheet" href="{{ pz_file('admin/plugin/fileinput.min.css')}}"> --}}
...
{{-- input image --}}
{{-- <script src="{{ pz_file('admin/plugin/fileinput.min.js')}}"></script> --}}
...
$("[name='property']").change(function() {
    if($(this).val() == '{{ PZ_PROPERTY_DOWNLOAD }}') {
        $('#download_path').show();
    } else {
        $('#download_path').hide();
    }
...
@if (pz_config_admin('product_kind') && $product->kind == PZ_PRODUCT_GROUP)
...
@if (pz_config_admin('product_kind') && $product->kind == PZ_PRODUCT_BUILD)
...
$('textarea.editor').ckeditor(
    {
        filebrowserImageBrowseUrl: '{{ pz_route_admin('admin.home').'/'.config('lfm.url_prefix') }}?type=product',
        filebrowserImageUploadUrl: '{{ pz_route_admin('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=product&_token={{csrf_token()}}',
        filebrowserBrowseUrl: '{{ pz_route_admin('admin.home').'/'.config('lfm.url_prefix') }}?type=Files',
        filebrowserUploadUrl: '{{ pz_route_admin('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=file&_token={{csrf_token()}}',
