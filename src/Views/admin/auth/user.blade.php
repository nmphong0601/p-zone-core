                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ pz_route_admin('admin_user.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ pz_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            <div class="form-group  row {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2  control-label">{{ pz_language_render('admin.user.name') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group  row {{ $errors->has('username') ? ' text-red' : '' }}">
                                <label for="username" class="col-sm-2  control-label">{{ pz_language_render('admin.user.user_name') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group  row {{ $errors->has('email') ? ' text-red' : '' }}">
                                <label for="email" class="col-sm-2  control-label">{{ pz_language_render('admin.user.email') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            <div class="form-group  row {{ $errors->has('avatar') ? ' text-red' : '' }}">
                                <label for="avatar" class="col-sm-2  control-label">{{ pz_language_render('admin.user.avatar') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                       ...
                                       <span class="input-group-btn">
                                        ...
                                        @if (old('avatar',$user['avatar']??''))
                                            <img src="{{ pz_file(old('avatar',$user['avatar']??'')) }}">
                                        @endif
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row {{ $errors->has('password') ? ' text-red' : '' }}">
                                <label for="password" class="col-sm-2  control-label">{{ pz_language_render('admin.user.password') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                        ...
                                        @else
                                            @if ($user)
                                                <span class="form-text">
                                                     {{ pz_language_render('admin.user.keep_password') }}
                                                 </span>
                                            @endif
                                        @endif
                                </div>
                            ...
                            <div class="form-group  row {{ $errors->has('password_confirmation') ? ' text-red' : '' }}">
                                <label for="password" class="col-sm-2  control-label">{{ pz_language_render('admin.user.password_confirmation') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                            ...
                            @endphp
                                <label for="roles" class="col-sm-2  control-label">{{ pz_language_render('admin.user.select_roles') }}</label>
                                <div class="col-sm-8">

                            @if (isset($user['id']) && in_array($user['id'], PZ_GUARD_ADMIN))
                                @if (count($listRoles))
                                ...
                                @endif
                            @else
                                <select class="form-control roles select2"  multiple="multiple" data-placeholder="{{ pz_language_render('admin.user.select_roles') }}" style="width: 100%;" name="roles[]" >
                                    <option value=""></option>
                            ...
                            <div class="form-group row {{ $errors->has('permission') ? ' text-red' : '' }}">
                                ...
                                @endphp
                                <label for="permission" class="col-sm-2  control-label">{{ pz_language_render('admin.user.add_permission') }}</label>
                                <div class="col-sm-8">
                                    @if (isset($user['id']) && in_array($user['id'], PZ_GUARD_ADMIN))
                                        ...
                                        @endif
                                    @else
                                        <select class="form-control permission select2"  multiple="multiple" data-placeholder="{{ pz_language_render('admin.user.add_permission') }}" style="width: 100%;" name="permission[]" >
                                            <option value=""></option>
