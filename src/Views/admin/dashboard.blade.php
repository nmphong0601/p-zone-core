...
@section('main')
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-green"><i class="ion ion-iop-zone-outline"></i></span>
  
              <div class="info-box-content">
                <span class="info-box-text">{{ pz_language_render('admin.dashboard.total_order') }}</span>
                <span class="info-box-number">{{ number_format($totalOrder) }}</span>
                <a href="{{ pz_route_admin('admin_order.index') }}" class="small-box-footer">
                  {{ pz_language_render('action.view_more') }}&nbsp;
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">{{ pz_language_render('admin.dashboard.total_product') }}</span>
                <span class="info-box-number">{{ number_format($totalProduct) }}</span>
                <a href="{{ pz_route_admin('admin_product.index') }}" class="small-box-footer">
                    {{ pz_language_render('action.view_more') }}&nbsp;
                    <i class="fa fa-arrow-circle-right"></i>
                </a>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">{{ pz_language_render('admin.dashboard.total_customer') }}</span>
                <span class="info-box-number">{{ number_format($totalCustomer) }}</span>
                <a href="{{ pz_route_admin('admin_customer.index') }}" class="small-box-footer">
                    {{ pz_language_render('action.view_more') }}&nbsp;
                    <i class="fa fa-arrow-circle-right"></i>
                </a>
              </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">{{ pz_language_render('admin.dashboard.total_blog') }}</span>
                <span class="info-box-number">{{ number_format($totalNews) }}</span>
                <a href="{{ pz_route_admin('admin_news.index') }}" class="small-box-footer">
                    {{ pz_language_render('action.view_more') }}&nbsp;
                    <i class="fa fa-arrow-circle-right"></i>
                </a>
              </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">{{ pz_language_render('admin.dashboard.order_month') }}</h5>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">{{ pz_language_render('admin.dashboard.order_year') }}</h5>
        ...
        <div class="row">
          ...
          <div class="{{ config('admin.admin_dashboard.top_customer_new') ? 'col-md-6' : 'col-md-12' }}">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">{{ pz_language_render('admin.dashboard.top_order_new') }}</h3>
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>{{ pz_language_render('order.email') }}</th>
                        <th>{{ pz_language_render('order.status') }}</th>
                        <th>{{ pz_language_render('admin.created_at') }}</th>
                      </tr>
                    </thead>
                    <tbody>
                    @if (count($topOrder))
          ...
          <div class="{{ config('admin.admin_dashboard.top_order_new') ? 'col-md-6' : 'col-md-12' }}">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">{{ pz_language_render('admin.dashboard.top_customer_new') }}</h3>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    <tr>
                      <th>{{ pz_language_render('customer.email') }}</th>
                      <th>{{ pz_language_render('customer.name') }}</th>
                      <th>{{ pz_language_render('customer.admin.provider') }}</th>
                      <th>{{ pz_language_render('admin.created_at') }}</th>
                    </tr>
                    <tbody>
                      ...
                      @foreach ($topCustomer as $customer)
                        <tr>
                          <td><a href="{{ pz_route_admin('admin_customer.edit',['id'=>$customer->id]) }}">{{ $customer->email }}</a></td>
                          <td>{{ $customer->name }}</td>
...
@push('scripts')
  <script src="{{ pz_file('admin/plugin/chartjs/highcharts.js') }}"></script>
  <script src="{{ pz_file('admin/plugin/chartjs/highcharts-3d.js') }}"></script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
      var myChart = Highcharts.chart('chart-days', {
          ...
          title: {
              text: '{{ pz_language_render('admin.chart.static_30_day') }}'
          },
          xAxis: {
          ...
          yAxis: [{
              min: 0,
              title: {
                  text: '{{ pz_language_render('admin.chart.order') }}'
              },
          }, {
              title: {
                  text: '{{ pz_language_render('admin.chart.amount') }}'
              },
              opposite: true
          },
          ],
          ...
          {
              type: 'column',
              name: '{{ pz_language_render('admin.chart.order') }}',
          ...
          {
              type: 'line',
              name: '{{ pz_language_render('admin.chart.amount') }}',
              color: '#c7730c',
              yAxis: 1,
...
var chart = new Highcharts.Chart({
    ...
    title: {
        text: '{{ pz_language_render('admin.chart.static_month') }}'
    },
    subtitle: {
        text: '{{ pz_language_render('admin.chart.static_month_help') }}'
    },
    legend: {
            enabled: false,
      },
...
<script>
  Highcharts.chart('chart-pie', {
    ...
    series: [{
        type: 'pie',
        name: '{{ pz_language_render('admin.chart.device') }}',
        data: {!! $dataPie !!},
    }]
});
</script>
