...
<head>
    ...
    <link rel="icon" href="images/pzone-icon.png" type="image/png" sizes="16x16">
    <title>{{ $title }}</title>
...
<div class="container">
    ...
    <div class="col-md-5 col-sm-8">
        ...
        <div style="clear: both;display: block;">
            ...
            <p><b>{{ trans('install.info.version') }}</b>: {{ config('p-zone.version') }}</p>
            ...
            <div class="panel-body" >
                    <form  class="form-horizontal" id="formInstall">
                        ...
                        <div id="div_database_name" class="form-group info-install required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textInput form-control" id="database_name"  name="database_name" placeholder="{{ trans('install.database_name') }}" style="margin-bottom: 10px" type="text" value="p-zone" />
                            </div>
                        </div>
                        ...
                        <div id="div_database_prefix" class="form-group info-install">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textInput form-control" id="database_prefix"  name="database_prefix" placeholder="{{ trans('install.database_prefix_help') }}" style="margin-bottom: 10px" type="text"  value="pz_" />
                            </div>
                        </div>
                        <hr>
                        ...
                        <div id="div_admin_url" class="form-group info-install required">
                            ...
                            <div class="controls col-md-8">
                                <input class="input-md  textInput form-control" id="admin_url"  name="admin_url" placeholder="{{ trans('install.admin_url') }}" style="margin-bottom: 10px" type="text" value="pz_admin" />
                            </div>
                        </div>
