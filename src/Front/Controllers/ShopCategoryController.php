...
class ShopCategoryController extends RootFrontController
{
    ...
    private function _allCategories()
    {
        ...
        return view(
            ...
            array(
                'title'       => pz_language_render('front.categories'),
                'itemsList'   => $itemsList,
                'keyword'     => '',
                'description' => '',
                ...
                'breadcrumbs' => [
                    ['url'    => '', 'title' => pz_language_render('front.categories')],
                ],
            )
        );
    }
        ...
        if ($category) {
            ...
            return view(
                ...
                array(
                    ...
                    'og_image'    => pz_file($category->getImage()),
                    'filter_sort' => $filter_sort,
                    'breadcrumbs' => [
                        ['url'    => pz_route('category.all'), 'title' => pz_language_render('front.categories')],
