...
if (!function_exists('pz_product_admin_select_list') && !in_array('pz_get_plugin_captcha_installed', config('helper_except', []))) {
    /**
     ...
     */
    function pz_product_admin_select_list(array $dataFilter = [], $storeId = null)
    {
