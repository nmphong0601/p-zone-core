...
-- Dumping database structure for p-zone
CREATE DATABASE IF NOT EXISTS `p-zone` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `p-zone`;

-- Dumping structure for table p-zone.failed_jobs
...
-- Dumping data for table p-zone.failed_jobs: ~0 rows (approximately)
DELETE FROM `failed_jobs`;
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Dumping structure for table p-zone.jobs
...
-- Dumping data for table p-zone.jobs: ~0 rows (approximately)
DELETE FROM `jobs`;
/*!40000 ALTER TABLE `jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `jobs` ENABLE KEYS */;

-- Dumping structure for table p-zone.migrations
...
-- Dumping data for table p-zone.migrations: ~3 rows (approximately)
...
-- Dumping structure for table p-zone.personal_access_tokens
...
-- Dumping data for table p-zone.personal_access_tokens: ~0 rows (approximately)
DELETE FROM `personal_access_tokens`;
/*!40000 ALTER TABLE `personal_access_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_access_tokens` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_config
CREATE TABLE IF NOT EXISTS `pz_admin_config` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_config_key_store_id_unique` (`key`,`store_id`),
  KEY `pz_admin_config_code_index` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_config: ~142 rows (approximately)
DELETE FROM `pz_admin_config`;
/*!40000 ALTER TABLE `pz_admin_config` DISABLE KEYS */;
INSERT INTO `pz_admin_config` (`id`, `group`, `code`, `key`, `value`, `security`, `store_id`, `sort`, `detail`, `created_at`, `updated_at`) VALUES
	...
	(78, '', 'admin_config', 'ADMIN_NAME', 'P-Zone System', 0, '1', 0, 'admin.env.ADMIN_NAME', NULL, NULL),
	(79, '', 'admin_config', 'ADMIN_TITLE', 'P-Zone Admin', 0, '1', 0, 'admin.env.ADMIN_TITLE', NULL, NULL),
	(80, '', 'admin_config', 'ADMIN_LOGO', 'P-Zone <span class="brand-text font-weight-light">Admin</span>', 0, '1', 0, 'admin.env.ADMIN_LOGO', NULL, NULL),
...
/*!40000 ALTER TABLE `pz_admin_config` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_log
CREATE TABLE IF NOT EXISTS `pz_admin_log` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_admin_log_user_id_index` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_log: ~0 rows (approximately)
DELETE FROM `pz_admin_log`;
/*!40000 ALTER TABLE `pz_admin_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_admin_log` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_menu
CREATE TABLE IF NOT EXISTS `pz_admin_menu` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_menu_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_menu: ~68 rows (approximately)
DELETE FROM `pz_admin_menu`;
/*!40000 ALTER TABLE `pz_admin_menu` DISABLE KEYS */;
INSERT INTO `pz_admin_menu` (`id`, `parent_id`, `sort`, `title`, `icon`, `uri`, `type`, `hidden`, `key`, `created_at`, `updated_at`) VALUES
	...
	(39, 35, 0, 'p-zone::admin.menu_titles.plugin_payment', 'far fa-money-bill-alt', 'admin::plugin/payment', 0, 0, NULL, NULL, NULL),
	(40, 35, 1, 'p-zone::admin.menu_titles.plugin_shipping', 'fas fa-ambulance', 'admin::plugin/shipping', 0, 0, NULL, NULL, NULL),
	(41, 35, 2, 'p-zone::admin.menu_titles.plugin_total', 'fas fa-atom', 'admin::plugin/total', 0, 0, NULL, NULL, NULL),
	(42, 35, 100, 'p-zone::admin.menu_titles.plugin_other', 'far fa-circle', 'admin::plugin/other', 0, 0, NULL, NULL, NULL),
	(43, 35, 4, 'p-zone::admin.menu_titles.plugin_cms', 'fab fa-modx', 'admin::plugin/cms', 0, 0, NULL, NULL, NULL),
	...
	(53, 35, 3, 'p-zone::admin.menu_titles.plugin_fee', 'fas fa-box', 'admin::plugin/fee', 0, 0, NULL, NULL, NULL),
...
/*!40000 ALTER TABLE `pz_admin_menu` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_notice
CREATE TABLE IF NOT EXISTS `pz_admin_notice` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_admin_notice_type_index` (`type`),
  KEY `pz_admin_notice_type_id_index` (`type_id`),
  KEY `pz_admin_notice_status_index` (`status`),
  KEY `pz_admin_notice_admin_id_index` (`admin_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_notice: ~0 rows (approximately)
DELETE FROM `pz_admin_notice`;
/*!40000 ALTER TABLE `pz_admin_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_admin_notice` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_password_resets
CREATE TABLE IF NOT EXISTS `pz_admin_password_resets` (
  `email` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL,
  KEY `pz_admin_password_resets_email_index` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_password_resets: ~0 rows (approximately)
DELETE FROM `pz_admin_password_resets`;
/*!40000 ALTER TABLE `pz_admin_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_admin_password_resets` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_permission
CREATE TABLE IF NOT EXISTS `pz_admin_permission` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_permission_name_unique` (`name`),
  UNIQUE KEY `pz_admin_permission_slug_unique` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_permission: ~13 rows (approximately)
DELETE FROM `pz_admin_permission`;
/*!40000 ALTER TABLE `pz_admin_permission` DISABLE KEYS */;
INSERT INTO `pz_admin_permission` (`id`, `name`, `slug`, `http_uri`, `created_at`, `updated_at`) VALUES
	(1, 'Auth manager', 'auth.full', 'ANY::pz_admin/auth/*', NULL, NULL),
	(2, 'Dashboard', 'dashboard', 'GET::pz_admin', NULL, NULL),
	(3, 'Base setting', 'base.setting', 'ANY::pz_admin/order_status/*,ANY::pz_admin/shipping_status/*,ANY::pz_admin/payment_status/*,ANY::pz_admin/supplier/*,ANY::pz_admin/brand/*,ANY::pz_admin/custom_field/*,ANY::pz_admin/weight_unit/*,ANY::pz_admin/length_unit/*,ANY::pz_admin/attribute_group/*,ANY::pz_admin/tax/*', NULL, NULL),
	(4, 'Store manager', 'store.full', 'ANY::pz_admin/store_info/*,ANY::pz_admin/store_maintain/*,ANY::pz_admin/store_config/*,ANY::pz_admin/store_css/*,ANY::pz_admin/store_block/*,ANY::pz_admin/store_link/*', NULL, NULL),
	(5, 'Product manager', 'product.full', 'ANY::pz_admin/product/*,ANY::pz_admin/product_property/*,ANY::pz_admin/product_tag/*', NULL, NULL),
	(6, 'Category manager', 'category.full', 'ANY::pz_admin/category/*', NULL, NULL),
	(7, 'Order manager', 'order.full', 'ANY::pz_admin/order/*', NULL, NULL),
	(8, 'Upload management', 'upload.full', 'ANY::pz_admin/uploads/*', NULL, NULL),
	(9, 'Extension manager', 'extension.full', 'ANY::pz_admin/template/*,ANY::pz_admin/plugin/*', NULL, NULL),
	(10, 'Marketing manager', 'marketing.full', 'ANY::pz_admin/shop_discount/*,ANY::pz_admin/email_template/*,ANY::pz_admin/customer/*,ANY::pz_admin/subscribe/*,ANY::pz_admin/seo/*', NULL, NULL),
	(11, 'Report manager', 'report.full', 'ANY::pz_admin/report/*', NULL, NULL),
	(12, 'CMS full', 'cms.full', 'ANY::pz_admin/page/*,ANY::pz_admin/banner/*,ANY::pz_admin/banner_type/*,ANY::pz_admin/cms_category/*,ANY::pz_admin/cms_content/*,ANY::pz_admin/news/*', NULL, NULL),
	(13, 'Update config', 'change.config', 'POST::pz_admin/store_config/update', NULL, NULL);
/*!40000 ALTER TABLE `pz_admin_permission` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_role
CREATE TABLE IF NOT EXISTS `pz_admin_role` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_role_slug_unique` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_role: ~7 rows (approximately)
DELETE FROM `pz_admin_role`;
/*!40000 ALTER TABLE `pz_admin_role` DISABLE KEYS */;
INSERT INTO `pz_admin_role` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_admin_role` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_role_permission
CREATE TABLE IF NOT EXISTS `pz_admin_role_permission` (
  `role_id` int NOT NULL,
  `permission_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`role_id`,`permission_id`),
  KEY `pz_admin_role_permission_role_id_permission_id_index` (`role_id`,`permission_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_role_permission: ~30 rows (approximately)
DELETE FROM `pz_admin_role_permission`;
/*!40000 ALTER TABLE `pz_admin_role_permission` DISABLE KEYS */;
INSERT INTO `pz_admin_role_permission` (`role_id`, `permission_id`, `created_at`, `updated_at`) VALUES
	(3, 1, NULL, NULL),
	(3, 2, NULL, NULL),
	(3, 3, NULL, NULL),
	(3, 4, NULL, NULL),
	...
	(7, 12, NULL, NULL),
	(7, 13, NULL, NULL);
/*!40000 ALTER TABLE `pz_admin_role_permission` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_role_user
CREATE TABLE IF NOT EXISTS `pz_admin_role_user` (
  `role_id` int NOT NULL,
  `user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`role_id`,`user_id`),
  KEY `pz_admin_role_user_role_id_user_id_index` (`role_id`,`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_role_user: ~1 rows (approximately)
DELETE FROM `pz_admin_role_user`;
/*!40000 ALTER TABLE `pz_admin_role_user` DISABLE KEYS */;
INSERT INTO `pz_admin_role_user` (`role_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, '1', NULL, NULL);
/*!40000 ALTER TABLE `pz_admin_role_user` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_store
CREATE TABLE IF NOT EXISTS `pz_admin_store` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_store_code_unique` (`code`),
  KEY `pz_admin_store_domain_index` (`domain`),
  KEY `pz_admin_store_partner_index` (`partner`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_store: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `pz_admin_store_description` (
  ...
  KEY `pz_admin_store_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_store_description: ~2 rows (approximately)
DELETE FROM `pz_admin_store_description`;
/*!40000 ALTER TABLE `pz_admin_store_description` DISABLE KEYS */;
INSERT INTO `pz_admin_store_description` (`store_id`, `lang`, `title`, `description`, `keyword`, `maintain_content`, `maintain_note`) VALUES
	('1', 'en', 'Demo P-Zone : Free Laravel eCommerce', 'Free website shopping cart for business', '', '<center><img src="/images/maintenance.png" />\r\n            <h3><span style="color:#e74c3c;"><strong>Sorry! We are currently doing site maintenance!</strong></span></h3>\r\n            </center>', 'Website is in maintenance mode!'),
	('1', 'vi', 'Demo P-Zone: Mã nguồn website thương mại điện tử miễn phí', 'Laravel shopping cart for business', '', '<center><img src="/images/maintenance.png" />\r\n            <h3><span style="color:#e74c3c;"><strong>Xin lỗi! Hiện tại website đang bảo trì!</strong></span></h3>\r\n            </center>', 'Website đang trong chế độ bảo trì!');
/*!40000 ALTER TABLE `pz_admin_store_description` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_template
CREATE TABLE IF NOT EXISTS `pz_admin_template` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_template_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_template: ~1 rows (approximately)
DELETE FROM `pz_admin_template`;
/*!40000 ALTER TABLE `pz_admin_template` DISABLE KEYS */;
INSERT INTO `pz_admin_template` (`id`, `key`, `name`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'p-zone-light', 'P-Zone Light', 1, NULL, NULL);
/*!40000 ALTER TABLE `pz_admin_template` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_user
CREATE TABLE IF NOT EXISTS `pz_admin_user` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_admin_user_username_unique` (`username`),
  UNIQUE KEY `pz_admin_user_email_unique` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_user: ~1 rows (approximately)
DELETE FROM `pz_admin_user`;
/*!40000 ALTER TABLE `pz_admin_user` DISABLE KEYS */;
INSERT INTO `pz_admin_user` (`id`, `username`, `password`, `name`, `email`, `avatar`, `remember_token`, `theme`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_admin_user` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_admin_user_permission
CREATE TABLE IF NOT EXISTS `pz_admin_user_permission` (
  `user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `permission_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`,`permission_id`),
  KEY `pz_admin_user_permission_user_id_permission_id_index` (`user_id`,`permission_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_admin_user_permission: ~0 rows (approximately)
DELETE FROM `pz_admin_user_permission`;
/*!40000 ALTER TABLE `pz_admin_user_permission` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_admin_user_permission` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_api_connection
CREATE TABLE IF NOT EXISTS `pz_api_connection` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_api_connection_apiconnection_unique` (`apiconnection`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_api_connection: ~1 rows (approximately)
DELETE FROM `pz_api_connection`;
/*!40000 ALTER TABLE `pz_api_connection` DISABLE KEYS */;
INSERT INTO `pz_api_connection` (`id`, `description`, `apiconnection`, `apikey`, `expire`, `last_active`, `created_at`, `updated_at`, `status`) VALUES
	(1, 'Demo api connection', 'appmobile', '9aaaab35-7ffd-4d47-a0c3-f2320b08b3e2', NULL, NULL, NULL, NULL, 0);
/*!40000 ALTER TABLE `pz_api_connection` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_languages
CREATE TABLE IF NOT EXISTS `pz_languages` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_languages_code_location_unique` (`code`,`location`),
  KEY `pz_languages_code_index` (`code`),
  KEY `pz_languages_position_index` (`position`),
  KEY `pz_languages_location_index` (`location`)
) ENGINE=InnoDB AUTO_INCREMENT=2762 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_languages: ~2,761 rows (approximately)
DELETE FROM `pz_languages`;
/*!40000 ALTER TABLE `pz_languages` DISABLE KEYS */;
INSERT INTO `pz_languages` (`id`, `code`, `text`, `position`, `location`, `created_at`, `updated_at`) VALUES
	...
	(1522, 'admin.backup.guide', '<span class="text-danger">Chú ý: Bạn cần phải cài đặt đường dẫn hệ thống chính xác. Xem hướng dẫn <a target=_new href="https://p-zone.nmp-tech.com/guide/backup.html?lang=vi">TẠI ĐÂY</a></span>', 'admin.backup', 'vi', NULL, NULL),
	...
	(1536, 'admin.backup.guide', '<span class="text-danger">NOTE: To use MySQL server on the command line, you must have the correct system path. This is usually done automatically. Read document in <a target=_new href="https://p-zone.nmp-tech.com/guide/backup.html">HERE</a></span>', 'admin.backup', 'en', NULL, NULL),
	...
	(1941, 'email.email_action.help_note', '<span class="text-red">(*)</span>: Email sẽ không được gửi trực tiếp, mà thông qua hàng đợi. Bạn cần phải cài đặt "artisan schedule:run" trước,  chi tiết <a href="https://p-zone.nmp-tech.com/docs/master/email.html">TẠI ĐÂY</a>', 'email.admin', 'vi', NULL, NULL),
	(1942, 'email.email_action.help_note', '<span class="text-red">(*)</span>: Emails will not be sent directly, but through a queue. You need to set up "artisan schedule: run" first, details <a href="https://p-zone.nmp-tech.com/docs/master/email.html">HERE</a>', 'email.admin', 'en', NULL, NULL),
	...
	(2346, 'admin.template.template_more', '<a href="https://p-zone.nmp-tech.com/en/template.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download more HERE</a>', 'admin.template', 'en', NULL, NULL),
	...
	(2391, 'admin.template.template_more', '<a href="https://p-zone.nmp-tech.com/vi/template.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download đầy đủ Ở ĐÂY</a>', 'admin.template', 'vi', NULL, NULL),
	...
	(2475, 'admin.plugin.plugin_more', '<a href="https://p-zone.nmp-tech.com/vi/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download đầy đủ Ở ĐÂY</a>', 'admin.plugin', 'vi', NULL, NULL),
	...
	(2543, 'admin.plugin.plugin_more', '<a href="https://p-zone.nmp-tech.com/en/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download more HERE</a>', 'admin.plugin', 'en', NULL, NULL),
	...
	(2554, 'admin.plugin.not_compatible', 'Lỗi không tương thích. Plugin/template này chỉ hỗ trợ các phiên bản :version. Phiên bản hiện tại là :pz_version', 'admin.plugin', 'vi', NULL, NULL),
	(2555, 'admin.plugin.not_compatible', 'Incompatibility error. This plugin/template only supports :version versions. The current version is :pz_version', 'admin.plugin', 'en', NULL, NULL),
...
/*!40000 ALTER TABLE `pz_languages` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_attribute_group
CREATE TABLE IF NOT EXISTS `pz_shop_attribute_group` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  `sort` int NOT NULL DEFAULT '0',
...
-- Dumping data for table p-zone.pz_shop_attribute_group: ~2 rows (approximately)
DELETE FROM `pz_shop_attribute_group`;
/*!40000 ALTER TABLE `pz_shop_attribute_group` DISABLE KEYS */;
INSERT INTO `pz_shop_attribute_group` (`id`, `name`, `status`, `sort`, `type`, `created_at`, `updated_at`) VALUES
	(1, 'Color', 1, 1, 'radio', NULL, NULL),
	(2, 'Size', 1, 2, 'select', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_attribute_group` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_banner
CREATE TABLE IF NOT EXISTS `pz_shop_banner` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_banner_type_index` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_banner: ~8 rows (approximately)
DELETE FROM `pz_shop_banner`;
/*!40000 ALTER TABLE `pz_shop_banner` DISABLE KEYS */;
INSERT INTO `pz_shop_banner` (`id`, `title`, `image`, `url`, `target`, `html`, `status`, `sort`, `click`, `type`, `created_at`, `updated_at`) VALUES
	('9aaaab35-9ee6-4e19-877e-905481f47b2c', 'Banner home 1 (p-zone-light)', '/data/banner/banner-home-1.jpg', NULL, '_self', '', 1, 0, 0, 'banner', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab35-a08e-4d39-940e-97e8c1358cf7', 'Banner home 2 (p-zone-light)', '/data/banner/banner-home-2.jpg', NULL, '_self', '', 1, 0, 0, 'banner', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab35-a228-4bf8-bbfb-73e5615cf990', 'Banner breadcrumb (p-zone-light)', '/data/banner/breadcrumb.jpg', NULL, '_self', '', 1, 0, 0, 'breadcrumb', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab35-a397-455f-a63e-bfe6b7de54f7', 'Banner store (p-zone-light)', '/data/banner/banner-store.jpg', NULL, '_self', '', 1, 0, 0, 'banner-store', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab37-787e-4587-844f-52b3b1d2d464', 'Banner home 1 (p-zone-light)', '/data/banner/banner-home-1.jpg', NULL, '_self', '<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Top-notch Furniture</h1><p class="biggest text-white-70" data-caption-animate="fadeScale" data-caption-delay="200">Sofa Store provides the best furniture and accessories for homes and offices.</p><div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"> <span class="button button-zachem-tak-delat button-white button-zakaria"> Shop now</span> </div>', 1, 0, 0, 'banner', NULL, NULL),
	('9aaaab37-7887-4d25-9559-7d1bde707b15', 'Banner home 2 (p-zone-light)', '/data/banner/banner-home-2.jpg', NULL, '_self', '<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Top-notch Furniture</h1><p class="biggest text-white-70" data-caption-animate="fadeScale" data-caption-delay="200">Sofa Store provides the best furniture and accessories for homes and offices.</p><div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"> <span class="button button-zachem-tak-delat button-white button-zakaria"> Shop now</span> </div>', 1, 0, 0, 'banner', NULL, NULL),
	('9aaaab37-788c-417b-91c6-91fe6146141e', 'Banner breadcrumb (p-zone-light)', '/data/banner/breadcrumb.jpg', NULL, '_self', '', 1, 0, 0, 'breadcrumb', NULL, NULL),
	('9aaaab37-7890-4ccf-9d00-13c2a91701f8', 'Banner store (p-zone-light)', '/data/banner/banner-store.jpg', NULL, '_self', '', 1, 0, 0, 'banner-store', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_banner` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_banner_store
CREATE TABLE IF NOT EXISTS `pz_shop_banner_store` (
  `banner_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`banner_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_banner_store: ~8 rows (approximately)
DELETE FROM `pz_shop_banner_store`;
/*!40000 ALTER TABLE `pz_shop_banner_store` DISABLE KEYS */;
INSERT INTO `pz_shop_banner_store` (`banner_id`, `store_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_banner_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_banner_type
CREATE TABLE IF NOT EXISTS `pz_shop_banner_type` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_banner_type_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_banner_type: ~7 rows (approximately)
DELETE FROM `pz_shop_banner_type`;
/*!40000 ALTER TABLE `pz_shop_banner_type` DISABLE KEYS */;
INSERT INTO `pz_shop_banner_type` (`id`, `code`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_banner_type` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_brand
CREATE TABLE IF NOT EXISTS `pz_shop_brand` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_brand_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_brand: ~9 rows (approximately)
DELETE FROM `pz_shop_brand`;
/*!40000 ALTER TABLE `pz_shop_brand` DISABLE KEYS */;
INSERT INTO `pz_shop_brand` (`id`, `name`, `alias`, `image`, `url`, `status`, `sort`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_brand` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_brand_store
CREATE TABLE IF NOT EXISTS `pz_shop_brand_store` (
  `brand_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`brand_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_brand_store: ~9 rows (approximately)
DELETE FROM `pz_shop_brand_store`;
/*!40000 ALTER TABLE `pz_shop_brand_store` DISABLE KEYS */;
INSERT INTO `pz_shop_brand_store` (`brand_id`, `store_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_brand_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_category
CREATE TABLE IF NOT EXISTS `pz_shop_category` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alias` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_category_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_category: ~27 rows (approximately)
DELETE FROM `pz_shop_category`;
/*!40000 ALTER TABLE `pz_shop_category` DISABLE KEYS */;
INSERT INTO `pz_shop_category` (`id`, `image`, `alias`, `parent`, `top`, `status`, `sort`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_category` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_category_description
CREATE TABLE IF NOT EXISTS `pz_shop_category_description` (
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keyword` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  UNIQUE KEY `pz_shop_category_description_category_id_lang_unique` (`category_id`,`lang`),
  KEY `pz_shop_category_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_category_description: ~54 rows (approximately)
DELETE FROM `pz_shop_category_description`;
/*!40000 ALTER TABLE `pz_shop_category_description` DISABLE KEYS */;
INSERT INTO `pz_shop_category_description` (`category_id`, `lang`, `title`, `keyword`, `description`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_category_description` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_category_store
CREATE TABLE IF NOT EXISTS `pz_shop_category_store` (
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_category_store: ~27 rows (approximately)
DELETE FROM `pz_shop_category_store`;
/*!40000 ALTER TABLE `pz_shop_category_store` DISABLE KEYS */;
INSERT INTO `pz_shop_category_store` (`category_id`, `store_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_category_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_country
CREATE TABLE IF NOT EXISTS `pz_shop_country` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_country_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=246 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_country: ~245 rows (approximately)
DELETE FROM `pz_shop_country`;
/*!40000 ALTER TABLE `pz_shop_country` DISABLE KEYS */;
INSERT INTO `pz_shop_country` (`id`, `code`, `name`) VALUES
	(1, 'AL', 'Albania'),
	(2, 'DZ', 'Algeria'),
	(3, 'DS', 'American Samoa'),
	(4, 'AD', 'Andorra'),
	...
	(244, 'ZM', 'Zambia'),
	(245, 'ZW', 'Zimbabwe');
/*!40000 ALTER TABLE `pz_shop_country` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_currency
CREATE TABLE IF NOT EXISTS `pz_shop_currency` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_currency_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_currency: ~2 rows (approximately)
DELETE FROM `pz_shop_currency`;
/*!40000 ALTER TABLE `pz_shop_currency` DISABLE KEYS */;
INSERT INTO `pz_shop_currency` (`id`, `name`, `code`, `symbol`, `exchange_rate`, `precision`, `symbol_first`, `thousands`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	(1, 'USD Dola', 'USD', '$', 1.00, 2, 1, ',', 1, 0, NULL, NULL),
	(2, 'VietNam Dong', 'VND', '₫', 20000.00, 0, 0, ',', 1, 1, NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_currency` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_customer
CREATE TABLE IF NOT EXISTS `pz_shop_customer` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_customer_email_provider_provider_id_unique` (`email`,`provider`,`provider_id`),
  KEY `pz_shop_customer_address_id_index` (`address_id`),
  KEY `pz_shop_customer_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_customer: ~0 rows (approximately)
DELETE FROM `pz_shop_customer`;
/*!40000 ALTER TABLE `pz_shop_customer` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_customer` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_customer_address
CREATE TABLE IF NOT EXISTS `pz_shop_customer_address` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_customer_address_customer_id_index` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_customer_address: ~0 rows (approximately)
DELETE FROM `pz_shop_customer_address`;
/*!40000 ALTER TABLE `pz_shop_customer_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_customer_address` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_custom_field
CREATE TABLE IF NOT EXISTS `pz_shop_custom_field` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_custom_field_type_index` (`type`),
  KEY `pz_shop_custom_field_code_index` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_custom_field: ~0 rows (approximately)
DELETE FROM `pz_shop_custom_field`;
/*!40000 ALTER TABLE `pz_shop_custom_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_custom_field` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_custom_field_detail
CREATE TABLE IF NOT EXISTS `pz_shop_custom_field_detail` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_custom_field_detail_custom_field_id_index` (`custom_field_id`),
  KEY `pz_shop_custom_field_detail_rel_id_index` (`rel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_custom_field_detail: ~0 rows (approximately)
DELETE FROM `pz_shop_custom_field_detail`;
/*!40000 ALTER TABLE `pz_shop_custom_field_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_custom_field_detail` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_email_template
CREATE TABLE IF NOT EXISTS `pz_shop_email_template` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_email_template_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_email_template: ~6 rows (approximately)
DELETE FROM `pz_shop_email_template`;
/*!40000 ALTER TABLE `pz_shop_email_template` DISABLE KEYS */;
INSERT INTO `pz_shop_email_template` (`id`, `name`, `group`, `text`, `store_id`, `status`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_email_template` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_language
CREATE TABLE IF NOT EXISTS `pz_shop_language` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_language_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_language: ~2 rows (approximately)
DELETE FROM `pz_shop_language`;
/*!40000 ALTER TABLE `pz_shop_language` DISABLE KEYS */;
INSERT INTO `pz_shop_language` (`id`, `name`, `code`, `icon`, `status`, `rtl`, `sort`, `created_at`, `updated_at`) VALUES
	(1, 'English', 'en', '/data/language/flag_uk.png', 1, 0, 1, NULL, NULL),
	(2, 'Tiếng Việt', 'vi', '/data/language/flag_vn.png', 1, 0, 2, NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_language` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_layout_page
CREATE TABLE IF NOT EXISTS `pz_shop_layout_page` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_layout_page_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_layout_page: ~18 rows (approximately)
DELETE FROM `pz_shop_layout_page`;
/*!40000 ALTER TABLE `pz_shop_layout_page` DISABLE KEYS */;
INSERT INTO `pz_shop_layout_page` (`id`, `key`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_layout_page` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_layout_position
CREATE TABLE IF NOT EXISTS `pz_shop_layout_position` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_layout_position_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_layout_position: ~6 rows (approximately)
DELETE FROM `pz_shop_layout_position`;
/*!40000 ALTER TABLE `pz_shop_layout_position` DISABLE KEYS */;
INSERT INTO `pz_shop_layout_position` (`id`, `key`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_layout_position` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_length
CREATE TABLE IF NOT EXISTS `pz_shop_length` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_length_name_unique` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_length: ~4 rows (approximately)
DELETE FROM `pz_shop_length`;
/*!40000 ALTER TABLE `pz_shop_length` DISABLE KEYS */;
INSERT INTO `pz_shop_length` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'mm', 'Millimeter', NULL, NULL),
	(2, 'cm', 'Centimeter', NULL, NULL),
	(3, 'm', 'Meter ', NULL, NULL),
	(4, 'in', 'Inch ', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_length` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_link
CREATE TABLE IF NOT EXISTS `pz_shop_link` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table p-zone.pz_shop_link: ~11 rows (approximately)
DELETE FROM `pz_shop_link`;
/*!40000 ALTER TABLE `pz_shop_link` DISABLE KEYS */;
INSERT INTO `pz_shop_link` (`id`, `name`, `url`, `target`, `group`, `module`, `type`, `collection_id`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	('1', 'front.about', 'route::page.detail::about', '_self', 'menu', NULL, NULL, NULL, 1, 50, NULL, NULL),
	('2', 'P-Zone', '#collection', '_self', 'menu', NULL, 'collection', NULL, 1, 60, NULL, NULL),
	('3', 'About us', 'https://p-zone.nmp-tech.com/en/about.html', '_self', 'menu', NULL, NULL, '2', 1, 10, NULL, NULL),
	('4', 'Github', 'https://github.com/p-zone/p-zone', '_self', 'menu', NULL, NULL, '2', 1, 20, NULL, NULL),
...
/*!40000 ALTER TABLE `pz_shop_link` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_link_group
CREATE TABLE IF NOT EXISTS `pz_shop_link_group` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_link_group_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_link_group: ~7 rows (approximately)
DELETE FROM `pz_shop_link_group`;
/*!40000 ALTER TABLE `pz_shop_link_group` DISABLE KEYS */;
INSERT INTO `pz_shop_link_group` (`id`, `code`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_link_group` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_link_store
CREATE TABLE IF NOT EXISTS `pz_shop_link_store` (
  `link_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`link_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_link_store: ~11 rows (approximately)
DELETE FROM `pz_shop_link_store`;
/*!40000 ALTER TABLE `pz_shop_link_store` DISABLE KEYS */;
INSERT INTO `pz_shop_link_store` (`link_id`, `store_id`) VALUES
	('1', '1'),
	('2', '1'),
	('3', '1'),
	('4', '1'),
...
/*!40000 ALTER TABLE `pz_shop_link_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_news
CREATE TABLE IF NOT EXISTS `pz_shop_news` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_news_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_news: ~6 rows (approximately)
DELETE FROM `pz_shop_news`;
/*!40000 ALTER TABLE `pz_shop_news` DISABLE KEYS */;
INSERT INTO `pz_shop_news` (`id`, `image`, `alias`, `sort`, `status`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_news` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_news_description
CREATE TABLE IF NOT EXISTS `pz_shop_news_description` (
  ...
  UNIQUE KEY `pz_shop_news_description_news_id_lang_unique` (`news_id`,`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_news_description: ~12 rows (approximately)
DELETE FROM `pz_shop_news_description`;
/*!40000 ALTER TABLE `pz_shop_news_description` DISABLE KEYS */;
INSERT INTO `pz_shop_news_description` (`news_id`, `lang`, `title`, `keyword`, `description`, `content`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_news_description` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_news_store
CREATE TABLE IF NOT EXISTS `pz_shop_news_store` (
  `news_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`news_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_news_store: ~6 rows (approximately)
DELETE FROM `pz_shop_news_store`;
/*!40000 ALTER TABLE `pz_shop_news_store` DISABLE KEYS */;
INSERT INTO `pz_shop_news_store` (`news_id`, `store_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_news_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_order
CREATE TABLE IF NOT EXISTS `pz_shop_order` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_order_customer_id_index` (`customer_id`),
  KEY `pz_shop_order_device_type_index` (`device_type`),
  KEY `pz_shop_order_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_order: ~0 rows (approximately)
DELETE FROM `pz_shop_order`;
/*!40000 ALTER TABLE `pz_shop_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_order` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_order_detail
CREATE TABLE IF NOT EXISTS `pz_shop_order_detail` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table p-zone.pz_shop_order_detail: ~0 rows (approximately)
DELETE FROM `pz_shop_order_detail`;
/*!40000 ALTER TABLE `pz_shop_order_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_order_detail` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_order_history
CREATE TABLE IF NOT EXISTS `pz_shop_order_history` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table p-zone.pz_shop_order_history: ~0 rows (approximately)
DELETE FROM `pz_shop_order_history`;
/*!40000 ALTER TABLE `pz_shop_order_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_order_history` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_order_status
CREATE TABLE IF NOT EXISTS `pz_shop_order_status` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table p-zone.pz_shop_order_status: ~6 rows (approximately)
DELETE FROM `pz_shop_order_status`;
/*!40000 ALTER TABLE `pz_shop_order_status` DISABLE KEYS */;
INSERT INTO `pz_shop_order_status` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'New', NULL, NULL),
	...
	(5, 'Done', NULL, NULL),
	(6, 'Failed', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_order_status` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_order_total
CREATE TABLE IF NOT EXISTS `pz_shop_order_total` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_order_total_order_id_index` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_order_total: ~0 rows (approximately)
DELETE FROM `pz_shop_order_total`;
/*!40000 ALTER TABLE `pz_shop_order_total` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_order_total` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_page
CREATE TABLE IF NOT EXISTS `pz_shop_page` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alias` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int NOT NULL DEFAULT '0',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_page_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_page: ~1 rows (approximately)
DELETE FROM `pz_shop_page`;
/*!40000 ALTER TABLE `pz_shop_page` DISABLE KEYS */;
INSERT INTO `pz_shop_page` (`id`, `image`, `alias`, `status`, `created_at`, `updated_at`) VALUES
	('1', '', 'about', 1, NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_page` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_page_description
CREATE TABLE IF NOT EXISTS `pz_shop_page_description` (
  ...
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` mediumtext COLLATE utf8mb4_unicode_ci,
  UNIQUE KEY `pz_shop_page_description_page_id_lang_unique` (`page_id`,`lang`),
  KEY `pz_shop_page_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_page_description: ~2 rows (approximately)
DELETE FROM `pz_shop_page_description`;
/*!40000 ALTER TABLE `pz_shop_page_description` DISABLE KEYS */;
INSERT INTO `pz_shop_page_description` (`page_id`, `lang`, `title`, `keyword`, `description`, `content`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_page_description` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_page_store
CREATE TABLE IF NOT EXISTS `pz_shop_page_store` (
  `page_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`page_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_page_store: ~1 rows (approximately)
DELETE FROM `pz_shop_page_store`;
/*!40000 ALTER TABLE `pz_shop_page_store` DISABLE KEYS */;
INSERT INTO `pz_shop_page_store` (`page_id`, `store_id`) VALUES
	('1', '1');
/*!40000 ALTER TABLE `pz_shop_page_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_password_resets
CREATE TABLE IF NOT EXISTS `pz_shop_password_resets` (
  `email` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL,
  KEY `pz_shop_password_resets_email_index` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_password_resets: ~0 rows (approximately)
DELETE FROM `pz_shop_password_resets`;
/*!40000 ALTER TABLE `pz_shop_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_password_resets` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_payment_status
CREATE TABLE IF NOT EXISTS `pz_shop_payment_status` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table p-zone.pz_shop_payment_status: ~4 rows (approximately)
DELETE FROM `pz_shop_payment_status`;
/*!40000 ALTER TABLE `pz_shop_payment_status` DISABLE KEYS */;
INSERT INTO `pz_shop_payment_status` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'Unpaid', NULL, NULL),
	(2, 'Partial payment', NULL, NULL),
	(3, 'Paid', NULL, NULL),
	(4, 'Refurn', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_payment_status` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product
CREATE TABLE IF NOT EXISTS `pz_shop_product` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sku` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_product_sku_index` (`sku`),
  KEY `pz_shop_product_brand_id_index` (`brand_id`),
  KEY `pz_shop_product_supplier_id_index` (`supplier_id`),
  KEY `pz_shop_product_kind_index` (`kind`),
  KEY `pz_shop_product_property_index` (`property`),
  KEY `pz_shop_product_tax_id_index` (`tax_id`),
  KEY `pz_shop_product_status_index` (`status`),
  KEY `pz_shop_product_approve_index` (`approve`),
  KEY `pz_shop_product_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product: ~36 rows (approximately)
DELETE FROM `pz_shop_product`;
/*!40000 ALTER TABLE `pz_shop_product` DISABLE KEYS */;
INSERT INTO `pz_shop_product` (`id`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `image`, `brand_id`, `supplier_id`, `price`, `cost`, `stock`, `sold`, `minimum`, `weight_class`, `weight`, `length_class`, `length`, `width`, `height`, `kind`, `property`, `tax_id`, `status`, `approve`, `sort`, `view`, `alias`, `date_lastview`, `date_available`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_attribute
CREATE TABLE IF NOT EXISTS `pz_shop_product_attribute` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` tinyint NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `pz_shop_product_attribute_product_id_attribute_group_id_index` (`product_id`,`attribute_group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_attribute: ~8 rows (approximately)
DELETE FROM `pz_shop_product_attribute`;
/*!40000 ALTER TABLE `pz_shop_product_attribute` DISABLE KEYS */;
INSERT INTO `pz_shop_product_attribute` (`id`, `name`, `attribute_group_id`, `product_id`, `add_price`, `sort`, `status`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_attribute` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_build
CREATE TABLE IF NOT EXISTS `pz_shop_product_build` (
...
-- Dumping data for table p-zone.pz_shop_product_build: ~8 rows (approximately)
DELETE FROM `pz_shop_product_build`;
/*!40000 ALTER TABLE `pz_shop_product_build` DISABLE KEYS */;
INSERT INTO `pz_shop_product_build` (`build_id`, `product_id`, `quantity`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_build` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_category
CREATE TABLE IF NOT EXISTS `pz_shop_product_category` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`product_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_category: ~38 rows (approximately)
DELETE FROM `pz_shop_product_category`;
/*!40000 ALTER TABLE `pz_shop_product_category` DISABLE KEYS */;
INSERT INTO `pz_shop_product_category` (`product_id`, `category_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_category` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_description
CREATE TABLE IF NOT EXISTS `pz_shop_product_description` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` mediumtext COLLATE utf8mb4_unicode_ci,
  UNIQUE KEY `pz_shop_product_description_product_id_lang_unique` (`product_id`,`lang`),
  KEY `pz_shop_product_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_description: ~72 rows (approximately)
DELETE FROM `pz_shop_product_description`;
/*!40000 ALTER TABLE `pz_shop_product_description` DISABLE KEYS */;
INSERT INTO `pz_shop_product_description` (`product_id`, `lang`, `name`, `keyword`, `description`, `content`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_description` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_download
CREATE TABLE IF NOT EXISTS `pz_shop_product_download` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping data for table p-zone.pz_shop_product_download: ~0 rows (approximately)
DELETE FROM `pz_shop_product_download`;
/*!40000 ALTER TABLE `pz_shop_product_download` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_product_download` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_group
CREATE TABLE IF NOT EXISTS `pz_shop_product_group` (
  `group_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`group_id`,`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_group: ~8 rows (approximately)
DELETE FROM `pz_shop_product_group`;
/*!40000 ALTER TABLE `pz_shop_product_group` DISABLE KEYS */;
INSERT INTO `pz_shop_product_group` (`group_id`, `product_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_group` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_image
CREATE TABLE IF NOT EXISTS `pz_shop_product_image` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `pz_shop_product_image_product_id_index` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_image: ~24 rows (approximately)
DELETE FROM `pz_shop_product_image`;
/*!40000 ALTER TABLE `pz_shop_product_image` DISABLE KEYS */;
INSERT INTO `pz_shop_product_image` (`id`, `image`, `product_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_image` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_promotion
CREATE TABLE IF NOT EXISTS `pz_shop_product_promotion` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table p-zone.pz_shop_product_promotion: ~14 rows (approximately)
DELETE FROM `pz_shop_product_promotion`;
/*!40000 ALTER TABLE `pz_shop_product_promotion` DISABLE KEYS */;
INSERT INTO `pz_shop_product_promotion` (`product_id`, `price_promotion`, `date_start`, `date_end`, `status_promotion`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_promotion` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_property
CREATE TABLE IF NOT EXISTS `pz_shop_product_property` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_product_property_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_property: ~2 rows (approximately)
DELETE FROM `pz_shop_product_property`;
/*!40000 ALTER TABLE `pz_shop_product_property` DISABLE KEYS */;
INSERT INTO `pz_shop_product_property` (`id`, `code`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'physical', 'Product physical', NULL, NULL),
	(2, 'download', 'Product download', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_product_property` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_product_store
CREATE TABLE IF NOT EXISTS `pz_shop_product_store` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_product_store: ~36 rows (approximately)
DELETE FROM `pz_shop_product_store`;
/*!40000 ALTER TABLE `pz_shop_product_store` DISABLE KEYS */;
INSERT INTO `pz_shop_product_store` (`product_id`, `store_id`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_product_store` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_sessions
CREATE TABLE IF NOT EXISTS `pz_shop_sessions` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  UNIQUE KEY `pz_shop_sessions_id_unique` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_sessions: ~0 rows (approximately)
DELETE FROM `pz_shop_sessions`;
/*!40000 ALTER TABLE `pz_shop_sessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_sessions` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_shipping_standard
CREATE TABLE IF NOT EXISTS `pz_shop_shipping_standard` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table p-zone.pz_shop_shipping_standard: ~1 rows (approximately)
DELETE FROM `pz_shop_shipping_standard`;
/*!40000 ALTER TABLE `pz_shop_shipping_standard` DISABLE KEYS */;
INSERT INTO `pz_shop_shipping_standard` (`id`, `fee`, `shipping_free`, `created_at`, `updated_at`) VALUES
	(1, 20.00, 10000.00, NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_shipping_standard` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_shipping_status
CREATE TABLE IF NOT EXISTS `pz_shop_shipping_status` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table p-zone.pz_shop_shipping_status: ~3 rows (approximately)
DELETE FROM `pz_shop_shipping_status`;
/*!40000 ALTER TABLE `pz_shop_shipping_status` DISABLE KEYS */;
INSERT INTO `pz_shop_shipping_status` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'Not sent', NULL, NULL),
	(2, 'Sending', NULL, NULL),
	(3, 'Shipping done', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_shipping_status` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_shoppingcart
CREATE TABLE IF NOT EXISTS `pz_shop_shoppingcart` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  KEY `pz_shop_shoppingcart_identifier_instance_index` (`identifier`,`instance`),
  KEY `pz_shop_shoppingcart_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_shoppingcart: ~0 rows (approximately)
DELETE FROM `pz_shop_shoppingcart`;
/*!40000 ALTER TABLE `pz_shop_shoppingcart` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_shoppingcart` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_store_block
CREATE TABLE IF NOT EXISTS `pz_shop_store_block` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `position` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_store_block_store_id_index` (`store_id`),
  KEY `pz_shop_store_block_template_index` (`template`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_store_block: ~8 rows (approximately)
DELETE FROM `pz_shop_store_block`;
/*!40000 ALTER TABLE `pz_shop_store_block` DISABLE KEYS */;
INSERT INTO `pz_shop_store_block` (`id`, `name`, `position`, `page`, `type`, `text`, `status`, `sort`, `store_id`, `template`, `created_at`, `updated_at`) VALUES
	('9aaaab35-9c95-4efe-996d-82ffe054fc88', 'Banner top (p-zone-light)', 'banner_top', 'home', 'view', 'banner_image', 1, 10, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9cb2-470a-8b97-74abe2dd5af4', 'New product (p-zone-light)', 'top', 'home', 'view', 'product_new', 1, 20, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9ccb-4b73-b6fb-aaab1ea021bc', 'Top news (p-zone-light)', 'bottom', 'home', 'view', 'top_news', 1, 10, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9cde-4aaf-ade1-01c6c59665b3', 'Category store left (p-zone-light)', 'left', 'shop_home,vendor_home,vendor_product_list', 'view', 'category_store_left', 1, 10, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9cf1-42cc-806b-a9e557eb8de0', 'Category left (p-zone-light)', 'left', 'shop_product_list,shop_home', 'view', 'category_left', 1, 20, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9d04-4264-9079-8b716d8f6a05', 'Brand left (p-zone-light)', 'left', 'shop_product_list,shop_home', 'view', 'brand_left', 1, 30, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9d15-4ffa-962b-3fa3ef8ff658', 'Product last view (p-zone-light)', 'left', '*', 'view', 'product_lastview_left', 1, 40, '1', 'p-zone-light', NULL, NULL),
	('9aaaab35-9d26-4b35-be34-5771a51e2e14', 'Product special (p-zone-light)', 'left', '*', 'view', 'product_special_left', 1, 30, '1', 'p-zone-light', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_store_block` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_store_css
CREATE TABLE IF NOT EXISTS `pz_shop_store_css` (
  `css` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  UNIQUE KEY `pz_shop_store_css_store_id_template_unique` (`store_id`,`template`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_store_css: ~1 rows (approximately)
DELETE FROM `pz_shop_store_css`;
/*!40000 ALTER TABLE `pz_shop_store_css` DISABLE KEYS */;
INSERT INTO `pz_shop_store_css` (`css`, `store_id`, `template`, `created_at`, `updated_at`) VALUES
	('####CSS HERE ######', '1', 'p-zone-light', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_store_css` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_subscribe
CREATE TABLE IF NOT EXISTS `pz_shop_subscribe` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_subscribe_email_index` (`email`),
  KEY `pz_shop_subscribe_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_subscribe: ~0 rows (approximately)
DELETE FROM `pz_shop_subscribe`;
/*!40000 ALTER TABLE `pz_shop_subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `pz_shop_subscribe` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_supplier
CREATE TABLE IF NOT EXISTS `pz_shop_supplier` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pz_shop_supplier_alias_index` (`alias`),
  KEY `pz_shop_supplier_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_supplier: ~2 rows (approximately)
DELETE FROM `pz_shop_supplier`;
/*!40000 ALTER TABLE `pz_shop_supplier` DISABLE KEYS */;
INSERT INTO `pz_shop_supplier` (`id`, `name`, `alias`, `email`, `phone`, `image`, `address`, `url`, `status`, `store_id`, `sort`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `pz_shop_supplier` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_tax
CREATE TABLE IF NOT EXISTS `pz_shop_tax` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table p-zone.pz_shop_tax: ~1 rows (approximately)
DELETE FROM `pz_shop_tax`;
/*!40000 ALTER TABLE `pz_shop_tax` DISABLE KEYS */;
INSERT INTO `pz_shop_tax` (`id`, `name`, `value`, `created_at`, `updated_at`) VALUES
	(1, 'Tax default (10%)', 10, NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_tax` ENABLE KEYS */;

-- Dumping structure for table p-zone.pz_shop_weight
CREATE TABLE IF NOT EXISTS `pz_shop_weight` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pz_shop_weight_name_unique` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table p-zone.pz_shop_weight: ~4 rows (approximately)
DELETE FROM `pz_shop_weight`;
/*!40000 ALTER TABLE `pz_shop_weight` DISABLE KEYS */;
INSERT INTO `pz_shop_weight` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'g', 'Gram', NULL, NULL),
	(2, 'kg', 'Kilogram', NULL, NULL),
	(3, 'lb', 'Pound ', NULL, NULL),
	(4, 'oz', 'Ounce ', NULL, NULL);
/*!40000 ALTER TABLE `pz_shop_weight` ENABLE KEYS */;
