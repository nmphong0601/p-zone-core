...
class AdminStoreCssController extends RootAdminController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => pz_language_render('store.admin.css').' #'.$storeId,
            'subTitle' => '',
            'title_description' => '',
            'template' => $template,
            'templates' => $templates,
            ...
            'icon' => 'fa fa-edit',
            'css' => $cssContent->css,
            'url_action' => pz_route_admin('admin_store_css.index'),
        ];
    ...
    public function postEdit()
    {
        ...
        $cssContent->save();
        return redirect()->route('admin_store_css.index', ['store_id' => $storeId])->with('success', pz_language_render('action.edit_success'));
    }
}
