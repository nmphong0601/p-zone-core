...
use PZone\Core\Admin\Models\AdminLog;
...
class AdminLogController extends RootAdminController
{
    ...
    {
        $data = [
            'title' => pz_language_render('admin.log.list'),
            'subTitle' => '',
            'icon' => 'fa fa-indent',
            'urlDeleteItem' => pz_route_admin('admin_log.delete'),
        ...
        $listTh = [
            'id' => 'ID',
            'user' => pz_language_render('admin.log.user'),
            'method' => pz_language_render('admin.log.method'),
            'path' => pz_language_render('admin.log.path'),
            'ip' => pz_language_render('admin.log.ip'),
            'user_agent' => pz_language_render('admin.log.user_agent'),
            'input' => pz_language_render('admin.log.input'),
            'created_at' => pz_language_render('admin.log.created_at'),
        ...
        $arrSort = [
            ...
            'user_id__desc' => pz_language_render('filter_sort.value_desc', ['value' => 'ID']),
            'user_id__asc' => pz_language_render('filter_sort.value_asc', ['value' => 'ID']),
            'path__desc' => pz_language_render('filter_sort.alpha_desc', ['alpha' => 'path']),
            'path__asc' => pz_language_render('filter_sort.alpha_asc', ['alpha' => 'path']),
            'user_agent__desc' => pz_language_render('filter_sort.alpha_desc', ['alpha' => 'User agent']),
            'user_agent__asc' => pz_language_render('filter_sort.alpha_asc', ['alpha' => 'User agent']),
            'method__desc' => pz_language_render('filter_sort.alpha_desc', ['alpha' => 'Method']),
            'method__asc' => pz_language_render('filter_sort.alpha_asc', ['alpha' => 'Method']),
            'ip__desc' => pz_language_render('filter_sort.alpha_desc', ['alpha' => 'Ip']),
            'ip__asc' => pz_language_render('filter_sort.alpha_asc', ['alpha' => 'Ip']),
        ...
        //topMenuRight
        $data['topMenuRight'][] ='
                <form action="' . pz_route_admin('admin_log.index') . '" id="button_search">
