...
class AdminWeightController extends RootAdminController
{
    ...
    {
        $data = [
            'title' => pz_language_render('admin.weightlist'),
            'title_action' => '<i class="fa fa-plus" aria-hidden="true"></i> ' . pz_language_render('admin.weightadd_new_title'),
            'subTitle' => '',
            'icon' => 'fa fa-indent',
            'urlDeleteItem' => pz_route_admin('admin_weight_unit.delete'),
            'removeList' => 0, // 1 - Enable function delete list item
            'buttonRefresh' => 0, // 1 - Enable button refresh
            'css' => '',
            'js' => '',
            'url_action' => pz_route_admin('admin_weight_unit.create'),
        ];

        $listTh = [
            'name' => pz_language_render('admin.weightname'),
            'description' => pz_language_render('admin.weightdescription'),
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[$row['id']] = [
                ...
                'action' => '
                    <a href="' . pz_route_admin('admin_weight_unit.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . pz_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
    ...
    public function postCreate()
    {
        ...
        return redirect()->route('admin_weight_unit.index')->with('success', pz_language_render('action.create_success'));
    }
    ...
    public function edit($id)
    {
        ...
        'css' => '',
        'js' => '',
        'url_action' => pz_route_admin('admin_weight_unit.edit', ['id' => $weight['id']]),
        'weight' => $weight,
        'id' => $id,
    ];
    ...
    public function postEdit($id)
    {
        ...
        return redirect()->back()->with('success', pz_language_render('admin.edit_success'));
    }
