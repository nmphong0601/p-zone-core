...
class AdminCustomerController extends RootAdminController
{
    ...
    {
        $data = [
            'title'         => pz_language_render('customer.admin.list'),
            'subTitle'      => '',
            'icon'          => 'fa fa-indent',
            'urlDeleteItem' => pz_route_admin('admin_customer.delete'),
        ...
        $listTh = [
            'email'      => pz_language_render('customer.email'),
            'name'       => pz_language_render('customer.name'),
            'phone'      => pz_language_render('customer.phone'),
            'address1'   => pz_language_render('customer.address1'),
            'address2'   => pz_language_render('customer.address2'),
            'address3'   => pz_language_render('customer.address3'),
            'country'    => pz_language_render('customer.country'),
            'status'     => pz_language_render('customer.status'),
            'created_at' => pz_language_render('admin.created_at'),
        ...
        $arrSort = [
            ...
            'first_name__desc' => pz_language_render('filter_sort.first_name_desc'),
            'first_name__asc' => pz_language_render('filter_sort.first_name_asc'),
            'last_name__desc' => pz_language_render('filter_sort.last_name_desc'),
            'last_name__asc' => pz_language_render('filter_sort.last_name_asc'),
        ];
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[$row['id']] = [
                ...
                'action' => '
                    <a href="' . pz_route_admin('admin_customer.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . pz_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
        ...
        //menuRight
        $data['menuRight'][] = '<a href="' . pz_route_admin('admin_customer.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
                           <i class="fa fa-plus" title="'.pz_language_render('admin.add_new').'"></i>
                           </a>';
        //=menuRight
        ...
        //menuSearch
        $data['topMenuRight'][] = '
                <form action="' . pz_route_admin('admin_customer.index') . '" id="button_search">
    ...
    {
        $data = [
            'title'             => pz_language_render('customer.admin.add_new_title'),
            'subTitle'          => '',
            'title_description' => pz_language_render('customer.admin.add_new_des'),
            'icon'              => 'fa fa-plus',
            'countries'         => (new ShopCountry)->getCodeAll(),
            'customer'          => [],
            'url_action'        => pz_route_admin('admin_customer.create'),
    ...
    public function postCreate()
    {
        ...
        if ($customer) {
            pz_customer_created_by_admin($customer, $dataMapping['dataInsert']);
        }

        return redirect()->route('admin_customer.index')->with('success', pz_language_render('action.create_success'));
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'url_action' => pz_route_admin('admin_customer.edit', ['id' => $customer['id']]),
            'customFields'         => (new ShopCustomField)->getCustomField($type = 'shop_customer'),
        ];
    ...
    public function postEdit($id)
    {
        ...
        return redirect()->route('admin_customer.index')->with('success', pz_language_render('action.edit_success'));
    }
    ...
    */
    ...
    public function updateAddress($id)
    {
        ...
        if ($address) {
            $title = pz_language_render('customer.address_detail').' #'.$address->id;
        } else {
            $title = pz_language_render('customer.address_detail_notfound');
        }
        ...
        ->with(
            ...
            'url_action'  => pz_route_admin('admin_customer.update_address', ['id' => $id]),
            ]
        );
    }
    ...
    public function postUpdateAddress($id)
    {
        ...
        if (pz_config_admin('customer_lastname')) {
            if (pz_config_admin('customer_lastname_required')) {
        ...
        if (pz_config_admin('customer_address1')) {
            if (pz_config_admin('customer_address1_required')) {
        ...
        if (pz_config_admin('customer_address2')) {
            if (pz_config_admin('customer_address2_required')) {
        ...
        if (pz_config_admin('customer_address3')) {
            if (pz_config_admin('customer_address3_required')) {
        ...
        if (pz_config_admin('customer_phone')) {
            if (pz_config_admin('customer_phone_required')) {
        ...
        if (pz_config_admin('customer_country')) {
            ...
            if (pz_config_admin('customer_country_required')) {
        ...
        if (pz_config_admin('customer_postcode')) {
            if (pz_config_admin('customer_postcode_required')) {
        ...
        if (pz_config_admin('customer_name_kana')) {
            if (pz_config_admin('customer_name_kana_required')) {
