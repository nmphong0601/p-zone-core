...
use PZone\Core\Admin\Models\AdminEmailTemplate;
use Validator;
...
class AdminEmailTemplateController extends RootAdminController
{
    ...
    {
        $data = [
            'title'         => pz_language_render('admin.email_template.list'),
            'subTitle'      => '',
            'icon'          => 'fa fa-indent',
            'urlDeleteItem' => pz_route_admin('admin_email_template.delete'),
        ...
        $listTh = [
            'name' => pz_language_render('admin.email_template.name'),
            'group' => pz_language_render('admin.email_template.group'),
            'status' => pz_language_render('admin.email_template.status'),
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[$row['id']] = [
                ...
                'action' => '
                    <a href="' . pz_route_admin('admin_email_template.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . pz_language_render('action.admin.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
        ...
        //menuRight
        $data['menuRight'][] = '<a href="' . pz_route_admin('admin_email_template.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
    ...
    {
        $data = [
            'title' => pz_language_render('admin.email_template.add_new_title'),
            'subTitle' => '',
            'title_description' => pz_language_render('admin.email_template.add_new_des'),
            'icon' => 'fa fa-plus',
            'arrayGroup' => $this->arrayGroup(),
            'obj' => [],
            'url_action' => pz_route_admin('admin_email_template.create'),
        ];
    ...
    public function postCreate()
    {
        ...
        return redirect()->route('admin_email_template.index')->with('success', pz_language_render('action.create_success'));
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'obj' => $emailTemplate,
            'arrayGroup' => $this->arrayGroup(),
            'url_action' => pz_route_admin('admin_email_template.edit', ['id' => $emailTemplate['id']]),
        ];
        return view($this->templatePathAdmin.'screen.email_template')
            ->with($data);
    }
    ...
    public function postEdit($id)
    {
        ...
        return redirect()->route('admin_email_template.index')->with('success', pz_language_render('action.edit_success'));
    }
    ...
    */
    ...
    {
        return  [
            'order_success_to_admin' => pz_language_render('email.admin.order_success_to_admin'),
            'order_success_to_customer' => pz_language_render('email.admin.order_success_to_cutomer'),
            'forgot_password' => pz_language_render('email.admin.forgot_password'),
            'customer_verify' => pz_language_render('email.admin.customer_verify'),
            'welcome_customer' => pz_language_render('email.admin.welcome_customer'),
            'contact_to_admin' => pz_language_render('email.admin.contact_to_admin'),
            'other' => pz_language_render('email.admin.other'),
        ];
    }
