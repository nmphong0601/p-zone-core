...
class DashboardController extends RootAdminController
{
    ...
    public function index(Request $request)
    {
        ...
        if (!\Admin::user()->checkUrlAllowAccess(route('admin.home'))) {
            $data['title'] = pz_language_render('admin.dashboard');
        ...
        if (config('admin.admin_dashboard.pie_chart_type') == 'country') {
            ...
            $pieChartTitle = pz_language_render('admin.chart.static_country');
            //End countries
        }
        ...
        if (config('admin.admin_dashboard.pie_chart_type') == 'device') {
            ...
            $pieChartTitle = pz_language_render('admin.chart.static_device');
        ...
        if (config('admin.admin_dashboard.pie_chart_type') == 'order') {
            ...
            $pieChartTitle = pz_language_render('admin.chart.static_count_order');
    ...
    {
        $data = [
            'title' => pz_language_render('admin.data_not_found'),
            'icon' => '',
            'url' => session('url'),
        ];
    ...
    {
        $data = [
            'title' => pz_language_render('admin.deny'),
            'icon' => '',
