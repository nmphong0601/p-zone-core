...
namespace PZone\Core\Admin\Middleware;

use PZone\Core\Admin\Admin;
use PZone\Core\Admin\Permission;
...
class PermissionMiddleware
{
    ...
    protected function shouldPassThrough($request)
    {
        ...
        $exceptsPAth = [
            PZ_ADMIN_PREFIX . '/auth/login',
            PZ_ADMIN_PREFIX . '/auth/logout',
        ];
    ...
    */
    ...
    {
        return [
            PZ_ADMIN_PREFIX . '/uploads/delete',
            PZ_ADMIN_PREFIX . '/uploads/newfolder',
            PZ_ADMIN_PREFIX . '/uploads/domove',
            PZ_ADMIN_PREFIX . '/uploads/rename',
            PZ_ADMIN_PREFIX . '/uploads/resize',
            PZ_ADMIN_PREFIX . '/uploads/doresize',
            PZ_ADMIN_PREFIX . '/uploads/cropimage',
            PZ_ADMIN_PREFIX . '/uploads/crop',
            PZ_ADMIN_PREFIX . '/uploads/move',
        ];
    }
}
